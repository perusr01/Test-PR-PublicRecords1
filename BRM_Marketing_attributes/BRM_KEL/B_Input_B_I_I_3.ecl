...
EXPORT B_Input_B_I_I_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1057779 := __ENH_Input_B_I_I_4;
  ...
  END;
  SHARED __ST179551_Layout __ND1058150__Project(B_Input_B_I_I_4(__in,__cfg).__ST175931_Layout __PP1057780) := TRANSFORM
    __CC13679 := '-99999';
    __CC13684 := '-99998';
    SELF.B___Inp_Cln_Addr_Full_Flag_Value_ := FN_Compile(__cfg).FN_Is_Clean_Populated(__ECAST(KEL.typ.nstr,__PP1057780.Bus_Input_Full_Address_Clean_Value_),__ECAST(KEL.typ.nstr,__CN(__CC13679)),__ECAST(KEL.typ.nstr,__CN(__CC13684)));
    SELF := __PP1057780;
  END;
  EXPORT __ENH_Input_B_I_I_3 := PROJECT(__EE1057779,__ND1058150__Project(LEFT));
END;
