...
IMPORT KEL15 AS KEL;
IMPORT B_Criminal_Offense_7,CFG_Compile,E_Criminal_Offense FROM BRM_Marketing_attributes.BRM_KEL;
...
EXPORT B_Criminal_Offense_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE936178 := __ENH_Criminal_Offense_7;
  EXPORT __ST156748_Layout := RECORD
  ...
  EXPORT __ST156701_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST156748_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST156701_Layout __ND936551__Project(B_Criminal_Offense_7(__in,__cfg).__ST158775_Layout __PP936179) := TRANSFORM
    __EE936339 := __PP936179.Offense_Charges_;
    __ST156748_Layout __ND936539__Project(B_Criminal_Offense_7(__in,__cfg).__ST158822_Layout __PP936340) := TRANSFORM
      __CC13800 := '-99998';
      SELF.Valid_Date_ := IF(__T(__FN1(KEL.Routines.IsValidDate,__PP936340.My_Crim_Date_)),__ECAST(KEL.typ.nstr,__FN2(KEL.Routines.DateToString,__PP936340.My_Crim_Date_,__CN('%Y%m%d'))),__ECAST(KEL.typ.nstr,__CN(__CC13800)));
      SELF := __PP936340;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE936339,__ND936539__Project(LEFT));
    SELF := __PP936179;
  END;
  EXPORT __ENH_Criminal_Offense_6 := PROJECT(__EE936178,__ND936551__Project(LEFT));
END;
