...
EXPORT B_Input_B_I_I(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1492611 := __ENH_Input_B_I_I_1;
  SHARED __EE1492614 := __ENH_Input_P_I_I_1;
  SHARED __ST801534_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC1493211(B_Input_B_I_I_1(__in,__cfg).__ST180536_Layout __EE1492611, B_Input_P_I_I_1(__in,__cfg).__ST148763_Layout __EE1492614) := __EEQP(__EE1492611.Auth_Rep1_,__EE1492614.UID);
  __ST801534_Layout __JT1493211(B_Input_B_I_I_1(__in,__cfg).__ST180536_Layout __l, B_Input_P_I_I_1(__in,__cfg).__ST148763_Layout __r) := TRANSFORM
    ...
    SELF := __r;
  END;
  SHARED __EE1493212 := JOIN(__EE1492611,__EE1492614,__JC1493211(LEFT,RIGHT),__JT1493211(LEFT,RIGHT),LEFT OUTER,SMART);
  EXPORT __ST145062_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Business_Sele().Typ) Legal_;
    KEL.typ.nint G___Proc_Bus_U_I_D_;
    KEL.typ.nint B___Inp_Lex_I_D_Ult_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST145062_Layout __ND1493873__Project(__ST801534_Layout __PP1492624) := TRANSFORM
    __CC13682 := -99999;
    SELF.B___Lex_I_D_Legal_Score_Value_ := FN_Compile(__cfg).FN_Is_Zero(__ECAST(KEL.typ.nint,KEL.Routines.BoundsClip(__PP1492624.B___Lex_I_D_Legal_Score_,__CN(51),__CN(100))),__ECAST(KEL.typ.nint,__CN(__CC13682)));
    SELF.B___Lex_I_D_Legal_Value_ := FN_Compile(__cfg).FN_Is_Zero(__ECAST(KEL.typ.nint,__PP1492624.B___Lex_I_D_Legal_),__ECAST(KEL.typ.nint,__CN(__CC13682)));
    SELF.B___Lex_I_D_Loc_Value_ := FN_Compile(__cfg).FN_Is_Zero(__ECAST(KEL.typ.nint,__PP1492624.B___Lex_I_D_Loc_),__ECAST(KEL.typ.nint,__CN(__CC13682)));
    SELF.B___Lex_I_D_Org_Value_ := FN_Compile(__cfg).FN_Is_Zero(__ECAST(KEL.typ.nint,__PP1492624.B___Lex_I_D_Org_),__ECAST(KEL.typ.nint,__CN(__CC13682)));
    SELF.B___Lex_I_D_Site_Value_ := FN_Compile(__cfg).FN_Is_Zero(__ECAST(KEL.typ.nint,__PP1492624.B___Lex_I_D_Site_),__ECAST(KEL.typ.nint,__CN(__CC13682)));
    SELF.B___Lex_I_D_Ult_Value_ := FN_Compile(__cfg).FN_Is_Zero(__ECAST(KEL.typ.nint,__PP1492624.B___Lex_I_D_Ult_),__ECAST(KEL.typ.nint,__CN(__CC13682)));
    SELF.Bus_Input_Account_Echo_Value_ := __PP1492624.Input_Account_Value_;
    __CC13679 := '-99999';
    __CC13684 := '-99998';
    SELF.Bus_Input_Alternate_Name_Clean_Value_ := FN_Compile(__cfg).FN_Is_Blank2_Fields(__ECAST(KEL.typ.nstr,__PP1492624.B___Inp_Alt_Name_),__ECAST(KEL.typ.nstr,__CN(__CC13679)),__ECAST(KEL.typ.nstr,__PP1492624.B___Inp_Cln_Alt_Name_),__ECAST(KEL.typ.nstr,__CN(__CC13684)));
    SELF.Bus_Input_Email_Clean_Value_ := FN_Compile(__cfg).FN_Is_Blank2_Fields(__ECAST(KEL.typ.nstr,__PP1492624.B___Inp_Email_),__ECAST(KEL.typ.nstr,__CN(__CC13679)),__ECAST(KEL.typ.nstr,__PP1492624.B___Inp_Cln_Email_),__ECAST(KEL.typ.nstr,__CN(__CC13684)));
    SELF := __PP1492624;
  END;
  EXPORT __ENH_Input_B_I_I := PROJECT(__EE1493212,__ND1493873__Project(LEFT));
END;
