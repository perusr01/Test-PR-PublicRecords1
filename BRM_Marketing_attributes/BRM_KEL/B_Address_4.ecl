...
EXPORT B_Address_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE884628 := __ENH_Address_5;
  EXPORT __ST157920_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST157920_Layout __ND884462__Project(B_Address_5(__in,__cfg).__ST161623_Layout __PP883775) := TRANSFORM
    __EE884457 := __PP883775.Bestchild_Advo_;
    SELF.Res_Bus_Flag_ := (__T(__EE884457))[1].Residential_Or_Business_Indicator_;
    __EE884472 := __PP883775.Bestchild_Advo_;
    SELF.Vacant_Flag_ := (__T(__EE884472))[1].Vacancy_Indicator_;
    SELF := __PP883775;
  END;
  EXPORT __ENH_Address_4 := PROJECT(__EE884628,__ND884462__Project(LEFT));
END;
