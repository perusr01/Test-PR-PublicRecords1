...
IMPORT KEL15 AS KEL;
IMPORT CFG_Compile,E_Criminal_Offense FROM BRM_Marketing_attributes.BRM_KEL;
...
EXPORT B_Criminal_Offense_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE227861 := __E_Criminal_Offense;
  ...
  EXPORT __ST158775_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST158822_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST158775_Layout __ND228493__Project(E_Criminal_Offense(__in,__cfg).Layout __PP227456) := TRANSFORM
    __EE227681 := __PP227456.Offense_Charges_;
    __ST158822_Layout __ND228116__Project(E_Criminal_Offense(__in,__cfg).Offense_Charges_Layout __PP228112) := TRANSFORM
      SELF.My_Crim_Date_ := KEL.era.ToDate(__PP228112.Date_First_Seen_);
      SELF := __PP228112;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE227681,__ND228116__Project(LEFT));
    SELF := __PP227456;
  END;
  EXPORT __ENH_Criminal_Offense_7 := PROJECT(__EE227861,__ND228493__Project(LEFT));
END;
