...
EXPORT B_Input_P_I_I_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE714336 := __E_Input_P_I_I;
  EXPORT __ST148763_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST148763_Layout __ND1384208__Project(E_Input_P_I_I(__in,__cfg).Layout __PP713667) := TRANSFORM
    __CC13664 := '-99999';
    SELF.Input_Account_Value_ := FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP713667.P___Inp_Acct_),__ECAST(KEL.typ.nstr,__CN(__CC13664)));
    SELF := __PP713667;
  END;
  EXPORT __ENH_Input_P_I_I_1 := PROJECT(__EE714336,__ND1384208__Project(LEFT));
END;
