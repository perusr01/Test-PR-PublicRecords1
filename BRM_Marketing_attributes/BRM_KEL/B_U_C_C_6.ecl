...
EXPORT B_U_C_C_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE852029 := __ENH_U_C_C_7;
  ...
  END;
  EXPORT __ST166436_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST166440_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST166436_Layout __ND852034__Project(B_U_C_C_7(__in,__cfg).__ST167744_Layout __PP852030) := TRANSFORM
    __EE852069 := __PP852030.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE852069),__ST166440_Layout),__NL(__EE852069));
    SELF := __PP852030;
  END;
  EXPORT __ENH_U_C_C_6 := PROJECT(__EE852029,__ND852034__Project(LEFT));
END;
