...
EXPORT B_U_C_C_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE828692 := __ENH_U_C_C_8;
  EXPORT __ST167748_Layout := RECORD
  ...
  END;
  EXPORT __ST167744_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST167748_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST167744_Layout __ND828697__Project(B_U_C_C_8(__in,__cfg).__ST168733_Layout __PP828693) := TRANSFORM
    __EE828732 := __PP828693.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE828732),__ST167748_Layout),__NL(__EE828732));
    SELF := __PP828693;
  END;
  EXPORT __ENH_U_C_C_7 := PROJECT(__EE828692,__ND828697__Project(LEFT));
END;
