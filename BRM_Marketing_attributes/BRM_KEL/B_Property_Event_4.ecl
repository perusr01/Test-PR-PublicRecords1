...
EXPORT B_Property_Event_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE903385 := __ENH_Property_Event_5;
  ...
  END;
  SHARED __ST160545_Layout __ND903390__Project(B_Property_Event_5(__in,__cfg).__ST163666_Layout __PP903386) := TRANSFORM
    SELF.Dt_First_Seen_ := KEL.era.ToDate(__PP903386.Date_First_Seen_);
    SELF := __PP903386;
  END;
  EXPORT __ENH_Property_Event_4 := PROJECT(__EE903385,__ND903390__Project(LEFT));
END;
