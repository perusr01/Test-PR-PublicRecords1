...
EXPORT B_Sele_Person_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE882387 := __ENH_Sele_Person_6;
  EXPORT __ST163903_Layout := RECORD
  ...
  END;
  SHARED __ST163903_Layout __ND882510__Project(B_Sele_Person_6(__in,__cfg).__ST166029_Layout __PP882388) := TRANSFORM
    __CC65247 := 730;
    SELF.Two_Years_ := __OP2(__PP882388.Age_In_Days_,<=,__CN(__CC65247));
    SELF := __PP882388;
  END;
  EXPORT __ENH_Sele_Person_5 := PROJECT(__EE882387,__ND882510__Project(LEFT));
END;
