...
EXPORT B_U_C_C_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE911535 := __ENH_U_C_C_5;
  EXPORT __ST161546_Layout := RECORD
  ...
  END;
  EXPORT __ST161542_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST161546_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST161542_Layout __ND911769__Project(B_U_C_C_5(__in,__cfg).__ST164439_Layout __PP911536) := TRANSFORM
    __EE911576 := __PP911536.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE911576),__ST161546_Layout),__NL(__EE911576));
    SELF.Terminated_Filing_ := __OP2(__PP911536.Best_Inferred_Status_,=,__CN('3'));
    SELF := __PP911536;
  END;
  EXPORT __ENH_U_C_C_4 := PROJECT(__EE911535,__ND911769__Project(LEFT));
END;
