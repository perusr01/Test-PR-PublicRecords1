...
EXPORT B_Input_B_I_I_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE827748 := __ENH_Input_B_I_I_8;
  EXPORT __ST174600_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST174600_Layout __ND828114__Project(B_Input_B_I_I_8(__in,__cfg).__ST168406_Layout __PP827749) := TRANSFORM
    __CC13679 := '-99999';
    __CC13684 := '-99998';
    SELF.Bus_Input_Addr_Suffix_Clean_Value_ := MAP(__PP827749.Addr_Not_Populated_=>__ECAST(KEL.typ.nstr,__CN(__CC13679)),__T(__PP827749.City_State_Zip_Not_Populated_)=>__ECAST(KEL.typ.nstr,__CN(__CC13684)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP827749.B___Inp_Cln_Addr_Sffx_),__ECAST(KEL.typ.nstr,__CN(__CC13684)))));
    SELF.Bus_Input_Post_Dir_Clean_Value_ := MAP(__PP827749.Addr_Not_Populated_=>__ECAST(KEL.typ.nstr,__CN(__CC13679)),__T(__PP827749.City_State_Zip_Not_Populated_)=>__ECAST(KEL.typ.nstr,__CN(__CC13684)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP827749.B___Inp_Cln_Addr_Post_Dir_),__ECAST(KEL.typ.nstr,__CN(__CC13684)))));
    SELF.Bus_Input_Pre_Dir_Clean_Value_ := MAP(__PP827749.Addr_Not_Populated_=>__ECAST(KEL.typ.nstr,__CN(__CC13679)),__T(__PP827749.City_State_Zip_Not_Populated_)=>__ECAST(KEL.typ.nstr,__CN(__CC13684)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP827749.B___Inp_Cln_Addr_Pre_Dir_),__ECAST(KEL.typ.nstr,__CN(__CC13684)))));
    SELF.Bus_Input_Prim_Name_Clean_Value_ := MAP(__PP827749.Addr_Not_Populated_=>__ECAST(KEL.typ.nstr,__CN(__CC13679)),__T(__PP827749.City_State_Zip_Not_Populated_)=>__ECAST(KEL.typ.nstr,__CN(__CC13684)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP827749.B___Inp_Cln_Addr_Prim_Name_),__ECAST(KEL.typ.nstr,__CN(__CC13684)))));
    SELF.Bus_Input_Prim_Range_Clean_Value_ := MAP(__PP827749.Addr_Not_Populated_=>__ECAST(KEL.typ.nstr,__CN(__CC13679)),__T(__PP827749.City_State_Zip_Not_Populated_)=>__ECAST(KEL.typ.nstr,__CN(__CC13684)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP827749.B___Inp_Cln_Addr_Prim_Rng_),__ECAST(KEL.typ.nstr,__CN(__CC13684)))));
    SELF.Bus_Input_Sec_Range_Clean_Value_ := MAP(__PP827749.Addr_Not_Populated_=>__ECAST(KEL.typ.nstr,__CN(__CC13679)),__T(__PP827749.City_State_Zip_Not_Populated_)=>__ECAST(KEL.typ.nstr,__CN(__CC13684)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP827749.B___Inp_Cln_Addr_Sec_Rng_),__ECAST(KEL.typ.nstr,__CN(__CC13684)))));
    SELF.Bus_Input_Unit_Desig_Clean_Value_ := MAP(__PP827749.Addr_Not_Populated_=>__ECAST(KEL.typ.nstr,__CN(__CC13679)),__T(__PP827749.City_State_Zip_Not_Populated_)=>__ECAST(KEL.typ.nstr,__CN(__CC13684)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP827749.B___Inp_Cln_Addr_Unit_Desig_),__ECAST(KEL.typ.nstr,__CN(__CC13684)))));
    SELF := __PP827749;
  END;
  EXPORT __ENH_Input_B_I_I_7 := PROJECT(__EE827748,__ND828114__Project(LEFT));
END;
