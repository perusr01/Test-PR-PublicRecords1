...
EXPORT B_Input_B_I_I_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE846817 := __ENH_Input_B_I_I_7;
  ...
  END;
  SHARED __ST174941_Layout __ND847313__Project(B_Input_B_I_I_7(__in,__cfg).__ST174600_Layout __PP846818) := TRANSFORM
    SELF.B___Inp_Addr_City_Flag_Value_ := FN_Compile(__cfg).FN_Is_Echo_Populated(__ECAST(KEL.typ.nstr,__PP846818.B___Inp_Addr_City_));
    SELF.B___Inp_Addr_State_Flag_Value_ := FN_Compile(__cfg).FN_Is_Echo_Populated(__ECAST(KEL.typ.nstr,__PP846818.B___Inp_Addr_State_));
    SELF.B___Inp_Addr_Zip_Flag_Value_ := FN_Compile(__cfg).FN_Is_Echo_Populated(__ECAST(KEL.typ.nstr,__PP846818.B___Inp_Addr_Zip_));
    __CC13679 := '-99999';
    __CC13684 := '-99998';
    SELF.Bus_Input_Street_Clean_Value_ := MAP(__PP846818.Addr_Not_Populated_=>__ECAST(KEL.typ.nstr,__CN(__CC13679)),__T(__AND(__AND(__AND(__AND(__AND(__AND(__OP2(__PP846818.Bus_Input_Prim_Range_Clean_Value_,=,__CN(__CC13684)),__OP2(__PP846818.Bus_Input_Pre_Dir_Clean_Value_,=,__CN(__CC13684))),__OP2(__PP846818.Bus_Input_Prim_Name_Clean_Value_,=,__CN(__CC13684))),__OP2(__PP846818.Bus_Input_Addr_Suffix_Clean_Value_,=,__CN(__CC13684))),__OP2(__PP846818.Bus_Input_Post_Dir_Clean_Value_,=,__CN(__CC13684))),__OP2(__PP846818.Bus_Input_Unit_Desig_Clean_Value_,=,__CN(__CC13684))),__OP2(__PP846818.Bus_Input_Sec_Range_Clean_Value_,=,__CN(__CC13684))))=>__ECAST(KEL.typ.nstr,__CN(__CC13684)),__ECAST(KEL.typ.nstr,__OP2(__OP2(__OP2(__OP2(__OP2(__OP2(IF(__T(__OP2(__PP846818.Bus_Input_Prim_Range_Clean_Value_,=,__CN(__CC13684))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP846818.B___Inp_Cln_Addr_Prim_Rng_),+,__CN(' ')))),+,IF(__T(__OP2(__PP846818.Bus_Input_Pre_Dir_Clean_Value_,=,__CN(__CC13684))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP846818.B___Inp_Cln_Addr_Pre_Dir_),+,__CN(' '))))),+,IF(__T(__OP2(__PP846818.Bus_Input_Prim_Name_Clean_Value_,=,__CN(__CC13684))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP846818.B___Inp_Cln_Addr_Prim_Name_),+,__CN(' '))))),+,IF(__T(__OP2(__PP846818.Bus_Input_Addr_Suffix_Clean_Value_,=,__CN(__CC13684))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP846818.B___Inp_Cln_Addr_Sffx_),+,__CN(' '))))),+,IF(__T(__OP2(__PP846818.Bus_Input_Post_Dir_Clean_Value_,=,__CN(__CC13684))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP846818.B___Inp_Cln_Addr_Post_Dir_),+,__CN(' '))))),+,IF(__T(__OP2(__PP846818.Bus_Input_Unit_Desig_Clean_Value_,=,__CN(__CC13684))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP846818.B___Inp_Cln_Addr_Unit_Desig_),+,__CN(' '))))),+,IF(__T(__OP2(__PP846818.Bus_Input_Sec_Range_Clean_Value_,=,__CN(__CC13684))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__FN1(TRIM,__PP846818.B___Inp_Cln_Addr_Sec_Rng_))))));
    SELF := __PP846818;
  END;
  EXPORT __ENH_Input_B_I_I_6 := PROJECT(__EE846817,__ND847313__Project(LEFT));
END;
