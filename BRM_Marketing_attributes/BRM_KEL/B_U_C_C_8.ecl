...
EXPORT B_U_C_C_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE823037 := __ENH_U_C_C_9;
  EXPORT __ST168737_Layout := RECORD
  ...
  END;
  EXPORT __ST168733_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST168737_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST168733_Layout __ND823042__Project(B_U_C_C_9(__in,__cfg).__ST169577_Layout __PP823038) := TRANSFORM
    __EE823077 := __PP823038.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE823077),__ST168737_Layout),__NL(__EE823077));
    SELF := __PP823038;
  END;
  EXPORT __ENH_U_C_C_8 := PROJECT(__EE823037,__ND823042__Project(LEFT));
END;
