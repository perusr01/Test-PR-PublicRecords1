...
EXPORT B_Address_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1257901 := __ENH_Address_2;
  EXPORT __ST145183_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST145183_Layout __ND1258352__Project(B_Address_2(__in,__cfg).__ST149247_Layout __PP1257902) := TRANSFORM
    SELF.Is_P_O_Box_ := __OR(__PP1257902.Is_P_O_Box_Zip_,__CN(__PP1257902.Is_P_O_Box_A_D_V_O_));
    SELF := __PP1257902;
  END;
  EXPORT __ENH_Address_1 := PROJECT(__EE1257901,__ND1258352__Project(LEFT));
END;
