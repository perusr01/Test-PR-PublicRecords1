...
EXPORT B_Input_B_I_I_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1378494 := __ENH_Input_B_I_I_2;
  SHARED __EE709594 := __E_Input_P_I_I;
  SHARED __EE1382356 := __EE709594(__T(__OP2(__EE709594.Rep_Number_,=,__CN(1))));
  SHARED __EE709592 := __E_Input_B_I_I_Input_P_I_I;
  SHARED __EE1381174 := __EE709592(__NN(__EE709592.B_I_I_) AND __NN(__EE709592.P_I_I_));
  SHARED __ST712044_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC1382362(E_Input_P_I_I(__in,__cfg).Layout __EE1382356, E_Input_B_I_I_Input_P_I_I(__in,__cfg).Layout __EE1381174) := __EEQP(__EE1381174.P_I_I_,__EE1382356.UID);
  __ST712044_Layout __JT1382362(E_Input_P_I_I(__in,__cfg).Layout __l, E_Input_B_I_I_Input_P_I_I(__in,__cfg).Layout __r) := TRANSFORM
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1382497 := JOIN(__EE1381174,__EE1382356,__JC1382362(RIGHT,LEFT),__JT1382362(RIGHT,LEFT),INNER,SMART);
  SHARED __ST710556_Layout := RECORD
    ...
    KEL.typ.epoch Vault_Date_Last_Seen_ := 0;
  END;
  SHARED __ST710556_Layout __ND1382502__Project(__ST712044_Layout __PP1382498) := TRANSFORM
    SELF.UID := __PP1382498.B_I_I_;
    SELF.U_I_D__1_ := __PP1382498.UID;
    SELF := __PP1382498;
  END;
  SHARED __EE1383039 := PROJECT(__EE1382497,__ND1382502__Project(LEFT));
  SHARED __ST710838_Layout := RECORD
    KEL.typ.ntyp(E_Input_B_I_I().Typ) UID;
    KEL.typ.nuid U_I_D__1_;
    KEL.typ.epoch Archive___Date_ := 0;
    KEL.typ.epoch Date_First_Seen_ := 0;
    ...
    KEL.typ.epoch Vault_Date_Last_Seen_ := 0;
  END;
  SHARED __EE1383053 := PROJECT(__EE1383039,__ST710838_Layout);
  SHARED __ST710866_Layout := RECORD
    KEL.typ.ntyp(E_Input_B_I_I().Typ) UID;
    ...
    KEL.typ.epoch Vault_Date_Last_Seen_ := 0;
  END;
  SHARED __EE1383068 := PROJECT(__EE1383053,TRANSFORM(__ST710866_Layout,SELF.O_N_L_Y___U_I_D_ := LEFT.U_I_D__1_,SELF := LEFT));
  SHARED __ST712868_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  __JC1383074(B_Input_B_I_I_2(__in,__cfg).__ST180106_Layout __EE1378494, __ST710866_Layout __EE1383068) := __EEQP(__EE1378494.UID,__EE1383068.UID);
  __ST712868_Layout __JT1383074(B_Input_B_I_I_2(__in,__cfg).__ST180106_Layout __l, __ST710866_Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE1383168 := JOIN(__EE1378494,__EE1383068,__JC1383074(LEFT,RIGHT),__JT1383074(LEFT,RIGHT),LEFT OUTER,SMART,KEEP(1));
  EXPORT __ST180536_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.ntyp(E_Business_Sele().Typ) Legal_;
    KEL.typ.nint G___Proc_Bus_U_I_D_;
    KEL.typ.nint B___Inp_Lex_I_D_Ult_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  EXPORT __ENH_Input_B_I_I_1 := PROJECT(__EE1383168,TRANSFORM(__ST180536_Layout,SELF.Auth_Rep1_ := LEFT.O_N_L_Y___U_I_D_,SELF := LEFT));
END;
