...
EXPORT B_Sele_Phone_Number_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE906879 := __ENH_Sele_Phone_Number_5;
  EXPORT __ST160998_Layout := RECORD
  ...
  END;
  EXPORT __ST160960_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST160998_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST160960_Layout __ND906884__Project(B_Sele_Phone_Number_5(__in,__cfg).__ST163965_Layout __PP906880) := TRANSFORM
    __EE906933 := __PP906880.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE906933),__ST160998_Layout),__NL(__EE906933));
    SELF := __PP906880;
  END;
  EXPORT __ENH_Sele_Phone_Number_4 := PROJECT(__EE906879,__ND906884__Project(LEFT));
END;
