...
EXPORT B_Sele_Phone_Number_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2508483 := __ENH_Sele_Phone_Number_4;
  EXPORT __ST194635_Layout := RECORD
  ...
  EXPORT __ST194597_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST194635_Layout) Data_Sources_;
    KEL.typ.epoch Archive___Date_ := 0;
    KEL.typ.epoch Date_First_Seen_ := 0;
    KEL.typ.epoch Date_Last_Seen_ := 0;
    KEL.typ.epoch Hybrid_Archive_Date_ := 0;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST194597_Layout __ND2508488__Project(B_Sele_Phone_Number_4(__in,__cfg).__ST202456_Layout __PP2508484) := TRANSFORM
    __EE2508536 := __PP2508484.Data_Sources_;
    SELF.Data_Sources_ := __PROJECT(__EE2508536,__ST194635_Layout);
    SELF := __PP2508484;
  END;
  EXPORT __ENH_Sele_Phone_Number_3 := PROJECT(__EE2508483,__ND2508488__Project(LEFT));
END;
