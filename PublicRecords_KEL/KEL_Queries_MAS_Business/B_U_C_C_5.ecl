...
EXPORT B_U_C_C_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1990896 := __ENH_U_C_C_6;
  EXPORT __ST207428_Layout := RECORD
  ...
  END;
  EXPORT __ST207424_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST207428_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST207424_Layout __ND1990858__Project(B_U_C_C_6(__in,__cfg).__ST210704_Layout __PP1990558) := TRANSFORM
    __EE1990899 := __PP1990558.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE1990899),__ST207428_Layout),__NL(__EE1990899));
    __EE1990853 := __PP1990558.Best_U_C_C_Child_Record_;
    SELF.Best_Inferred_Status_ := (PROJECT(__T(__EE1990853),TRANSFORM({KEL.typ.nstr __value},SELF.__value:=__CN(LEFT.Inferred_Status_))))[1].__value;
    SELF := __PP1990558;
  END;
  EXPORT __ENH_U_C_C_5 := PROJECT(__EE1990896,__ND1990858__Project(LEFT));
END;
