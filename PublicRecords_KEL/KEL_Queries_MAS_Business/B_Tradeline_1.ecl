...
EXPORT B_Tradeline_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE3225025 := __ENH_Tradeline_2;
  EXPORT __ST174956_Layout := RECORD
  ...
  END;
  EXPORT __ST174949_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST174956_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST174949_Layout __ND3225030__Project(B_Tradeline_2(__in,__cfg).__ST185757_Layout __PP3225026) := TRANSFORM
    __EE3225055 := __PP3225026.Records_;
    SELF.Records_ := __PROJECT(__EE3225055,__ST174956_Layout);
    SELF := __PP3225026;
  END;
  EXPORT __ENH_Tradeline_1 := PROJECT(__EE3225025,__ND3225030__Project(LEFT));
END;
