...
EXPORT B_Input_B_I_I_10(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE264628 := __E_Input_B_I_I;
  EXPORT __ST215603_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST215603_Layout __ND1878925__Project(E_Input_B_I_I(__in,__cfg).Layout __PP264287) := TRANSFORM
    __CC13679 := '-99999';
    __CC13684 := '-99998';
    SELF.Bus_Input_Name_Clean_Value_ := FN_Compile(__cfg).FN_Is_Blank2_Fields(__ECAST(KEL.typ.nstr,__PP264287.B___Inp_Name_),__ECAST(KEL.typ.nstr,__CN(__CC13679)),__ECAST(KEL.typ.nstr,__PP264287.B___Inp_Cln_Name_),__ECAST(KEL.typ.nstr,__CN(__CC13684)));
    SELF := __PP264287;
  END;
  EXPORT __ENH_Input_B_I_I_10 := PROJECT(__EE264628,__ND1878925__Project(LEFT));
END;
