...
EXPORT B_Input_B_I_I_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1985930 := __ENH_Input_B_I_I_6;
  EXPORT __ST219194_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST219194_Layout __ND1986378__Project(B_Input_B_I_I_6(__in,__cfg).__ST218761_Layout __PP1985931) := TRANSFORM
    __CC13679 := '-99999';
    __CC13684 := '-99998';
    SELF.B___Inp_Cln_Addr_St_Flag_Value_ := FN_Compile(__cfg).FN_Is_Clean_Populated(__ECAST(KEL.typ.nstr,__PP1985931.Bus_Input_Street_Clean_Value_),__ECAST(KEL.typ.nstr,__CN(__CC13679)),__ECAST(KEL.typ.nstr,__CN(__CC13684)));
    SELF.Bus_Input_City_Clean_Value_ := MAP(__T(__AND(__CN(__PP1985931.B___Inp_Addr_City_Flag_Value_ = '0'),__OR(__CN(__PP1985931.Addr_Not_Populated_),__PP1985931.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13679)),__T(__AND(__CN(__PP1985931.B___Inp_Addr_City_Flag_Value_ = '1'),__OR(__CN(__PP1985931.Addr_Not_Populated_),__PP1985931.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13684)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP1985931.B___Inp_Cln_Addr_City_),__ECAST(KEL.typ.nstr,__CN(__CC13684)))));
    SELF.Bus_Input_State_Clean_Value_ := MAP(__T(__AND(__CN(__PP1985931.B___Inp_Addr_State_Flag_Value_ = '0'),__OR(__CN(__PP1985931.Addr_Not_Populated_),__PP1985931.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13679)),__T(__AND(__CN(__PP1985931.B___Inp_Addr_State_Flag_Value_ = '1'),__OR(__CN(__PP1985931.Addr_Not_Populated_),__PP1985931.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13684)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP1985931.B___Inp_Cln_Addr_State_),__ECAST(KEL.typ.nstr,__CN(__CC13684)))));
    SELF.Bus_Input_Zip4_Clean_Value_ := MAP(__T(__AND(__CN(__PP1985931.B___Inp_Addr_Zip_Flag_Value_ = '0'),__OR(__CN(__PP1985931.Addr_Not_Populated_),__PP1985931.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13679)),__T(__AND(__CN(__PP1985931.B___Inp_Addr_Zip_Flag_Value_ = '1'),__OR(__CN(__PP1985931.Addr_Not_Populated_),__PP1985931.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13684)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP1985931.B___Inp_Cln_Addr_Zip4_),__ECAST(KEL.typ.nstr,__CN(__CC13684)))));
    SELF.Bus_Input_Zip5_Clean_Value_ := MAP(__T(__AND(__CN(__PP1985931.B___Inp_Addr_Zip_Flag_Value_ = '0'),__OR(__CN(__PP1985931.Addr_Not_Populated_),__PP1985931.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13679)),__T(__AND(__CN(__PP1985931.B___Inp_Addr_Zip_Flag_Value_ = '1'),__OR(__CN(__PP1985931.Addr_Not_Populated_),__PP1985931.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13684)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP1985931.B___Inp_Cln_Addr_Zip5_),__ECAST(KEL.typ.nstr,__CN(__CC13684)))));
    SELF.Clean_City_State_Zip_Not_Populated_ := FN_Compile(__cfg).FN_City_State_Zip_Not_Populated_Check(__ECAST(KEL.typ.nstr,__PP1985931.B___Inp_Cln_Addr_City_),__ECAST(KEL.typ.nstr,__PP1985931.B___Inp_Cln_Addr_State_),__ECAST(KEL.typ.nstr,__PP1985931.B___Inp_Cln_Addr_Zip5_));
    SELF := __PP1985931;
  END;
  EXPORT __ENH_Input_B_I_I_5 := PROJECT(__EE1985930,__ND1986378__Project(LEFT));
END;
