...
EXPORT B_Criminal_Offense_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2492870 := __ENH_Criminal_Offense_4;
  EXPORT __ST192491_Layout := RECORD
  ...
  END;
  EXPORT __ST192444_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST192491_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST192444_Layout __ND2492875__Project(B_Criminal_Offense_4(__in,__cfg).__ST200553_Layout __PP2492871) := TRANSFORM
    __EE2493031 := __PP2492871.Offense_Charges_;
    SELF.Offense_Charges_ := __PROJECT(__EE2493031,__ST192491_Layout);
    SELF := __PP2492871;
  END;
  EXPORT __ENH_Criminal_Offense_3 := PROJECT(__EE2492870,__ND2492875__Project(LEFT));
END;
