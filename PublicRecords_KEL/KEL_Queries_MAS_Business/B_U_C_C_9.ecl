...
EXPORT B_U_C_C_9(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1883773 := __ENH_U_C_C_10;
  EXPORT __ST215204_Layout := RECORD
  ...
  END;
  EXPORT __ST215200_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST215204_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST215200_Layout __ND1883736__Project(B_U_C_C_10(__in,__cfg).__ST215930_Layout __PP1883445) := TRANSFORM
    __EE1883776 := __PP1883445.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE1883776),__ST215204_Layout),__NL(__EE1883776));
    __EE1883731 := __PP1883445.Best_U_C_C_Child_Record_;
    SELF.Best_Child_R_M_S_I_D_ := (__T(__EE1883731))[1].R_M_S_I_D_;
    SELF := __PP1883445;
  END;
  EXPORT __ENH_U_C_C_9 := PROJECT(__EE1883773,__ND1883736__Project(LEFT));
END;
