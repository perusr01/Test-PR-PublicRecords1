...
EXPORT B_Address_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1944251 := __ENH_Address_6;
  ...
  END;
  SHARED __ST203260_Layout __ND1944085__Project(B_Address_6(__in,__cfg).__ST207505_Layout __PP1943398) := TRANSFORM
    __EE1944080 := __PP1943398.Bestchild_Advo_;
    SELF.Res_Bus_Flag_ := (__T(__EE1944080))[1].Residential_Or_Business_Indicator_;
    __EE1944095 := __PP1943398.Bestchild_Advo_;
    SELF.Vacant_Flag_ := (__T(__EE1944095))[1].Vacancy_Indicator_;
    SELF := __PP1943398;
  END;
  EXPORT __ENH_Address_5 := PROJECT(__EE1944251,__ND1944085__Project(LEFT));
END;
