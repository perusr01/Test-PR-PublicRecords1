...
EXPORT B_Sele_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2508659 := __ENH_Sele_Property_4;
  EXPORT __ST194719_Layout := RECORD
  ...
  END;
  SHARED __ST194719_Layout __ND2508664__Project(B_Sele_Property_4(__in,__cfg).__ST202575_Layout __PP2508660) := TRANSFORM
    SELF.Is_Currently_Owned_ := (__PP2508660.Property_Is_Owned_Assessment_ OR __PP2508660.Property_Is_Owned_Deed_) AND NOT (__PP2508660.Property_Is_Sold_);
    SELF := __PP2508660;
  END;
  EXPORT __ENH_Sele_Property_3 := PROJECT(__EE2508659,__ND2508664__Project(LEFT));
END;
