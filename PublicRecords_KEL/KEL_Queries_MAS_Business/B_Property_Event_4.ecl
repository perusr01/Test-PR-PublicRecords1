...
EXPORT B_Property_Event_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2119177 := __ENH_Property_Event_5;
  EXPORT __ST202030_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST202030_Layout __ND2119182__Project(B_Property_Event_5(__in,__cfg).__ST206488_Layout __PP2119178) := TRANSFORM
    SELF.Dt_First_Seen_ := KEL.era.ToDate(__PP2119178.Date_First_Seen_);
    SELF := __PP2119178;
  END;
  EXPORT __ENH_Property_Event_4 := PROJECT(__EE2119177,__ND2119182__Project(LEFT));
END;
