...
EXPORT B_Input_B_I_I_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2116530 := __ENH_Input_B_I_I_5;
  EXPORT __ST219754_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST219754_Layout __ND2117007__Project(B_Input_B_I_I_5(__in,__cfg).__ST219194_Layout __PP2116531) := TRANSFORM
    SELF.At_Position_ := FN_Compile(__cfg).FN_Find_Last_String_Instance(__ECAST(KEL.typ.nstr,__PP2116531.B___Inp_Email_),__ECAST(KEL.typ.nstr,__CN('@')));
    __CC13679 := '-99999';
    __CC13684 := '-99998';
    SELF.Bus_Input_Full_Address_Clean_Value_ := MAP(__T(__OR(__CN(__PP2116531.Addr_Not_Populated_),__PP2116531.City_State_Zip_Not_Populated_))=>__ECAST(KEL.typ.nstr,__CN(__CC13679)),__T(__OR(__OP2(__PP2116531.B___Inp_Cln_Addr_St_Flag_Value_,=,__CN('0')),__PP2116531.Clean_City_State_Zip_Not_Populated_))=>__ECAST(KEL.typ.nstr,__CN(__CC13684)),__ECAST(KEL.typ.nstr,__OP2(__OP2(__OP2(__OP2(__OP2(__OP2(__OP2(__OP2(__OP2(__OP2(IF(__T(__OP2(__PP2116531.Bus_Input_Prim_Range_Clean_Value_,=,__CN(__CC13684))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP2116531.B___Inp_Cln_Addr_Prim_Rng_),+,__CN(' ')))),+,IF(__T(__OP2(__PP2116531.Bus_Input_Pre_Dir_Clean_Value_,=,__CN(__CC13684))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP2116531.B___Inp_Cln_Addr_Pre_Dir_),+,__CN(' '))))),+,IF(__T(__OP2(__PP2116531.Bus_Input_Prim_Name_Clean_Value_,=,__CN(__CC13684))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP2116531.B___Inp_Cln_Addr_Prim_Name_),+,__CN(' '))))),+,IF(__T(__OP2(__PP2116531.Bus_Input_Addr_Suffix_Clean_Value_,=,__CN(__CC13684))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP2116531.B___Inp_Cln_Addr_Sffx_),+,__CN(' '))))),+,IF(__T(__OP2(__PP2116531.Bus_Input_Post_Dir_Clean_Value_,=,__CN(__CC13684))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP2116531.B___Inp_Cln_Addr_Post_Dir_),+,__CN(' '))))),+,IF(__T(__OP2(__PP2116531.Bus_Input_Unit_Desig_Clean_Value_,=,__CN(__CC13684))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP2116531.B___Inp_Cln_Addr_Unit_Desig_),+,__CN(' '))))),+,IF(__T(__OP2(__PP2116531.Bus_Input_Sec_Range_Clean_Value_,=,__CN(__CC13684))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP2116531.B___Inp_Cln_Addr_Sec_Rng_),+,__CN(' '))))),+,IF(__T(__OP2(__PP2116531.Bus_Input_City_Clean_Value_,=,__CN(__CC13684))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP2116531.B___Inp_Cln_Addr_City_),+,__CN(' '))))),+,IF(__T(__OP2(__PP2116531.Bus_Input_State_Clean_Value_,=,__CN(__CC13684))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP2116531.B___Inp_Cln_Addr_State_),+,__CN(' '))))),+,IF(__T(__OP2(__PP2116531.Bus_Input_Zip5_Clean_Value_,=,__CN(__CC13684))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP2116531.B___Inp_Cln_Addr_Zip5_),+,__CN(' '))))),+,IF(__T(__OP2(__PP2116531.Bus_Input_Zip4_Clean_Value_,=,__CN(__CC13684))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__FN1(TRIM,__PP2116531.B___Inp_Cln_Addr_Zip4_))))));
    SELF := __PP2116531;
  END;
  EXPORT __ENH_Input_B_I_I_4 := PROJECT(__EE2116530,__ND2117007__Project(LEFT));
END;
