...
EXPORT B_Lien_Judgment_12(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE249465 := __E_Lien_Judgment;
  EXPORT __ST216237_Layout := RECORD
  ...
  END;
  EXPORT __ST216232_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.nstr R_M_S_I_D_;
    KEL.typ.ndataset(__ST216237_Layout) Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST216232_Layout __ND249774__Project(E_Lien_Judgment(__in,__cfg).Layout __PP249707) := TRANSFORM
    __EE249313 := __PP249707.Filing_;
    __ST216237_Layout __ND249710__Project(E_Lien_Judgment(__in,__cfg).Filing_Layout __PP249709) := TRANSFORM
      SELF.T_M_S_I_D_ := __PP249707.T_M_S_I_D_;
      SELF := __PP249709;
    END;
    SELF.Filing_ := __PROJECT(__EE249313,__ND249710__Project(LEFT));
    SELF := __PP249707;
  END;
  EXPORT __ENH_Lien_Judgment_12 := PROJECT(__EE249465,__ND249774__Project(LEFT));
END;
