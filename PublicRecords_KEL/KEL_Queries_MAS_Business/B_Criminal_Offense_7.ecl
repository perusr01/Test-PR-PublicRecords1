...
EXPORT B_Criminal_Offense_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE309395 := __E_Criminal_Offense;
  EXPORT __ST211689_Layout := RECORD
  ...
  END;
  EXPORT __ST211642_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST211689_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST211642_Layout __ND310027__Project(E_Criminal_Offense(__in,__cfg).Layout __PP308990) := TRANSFORM
    __EE309215 := __PP308990.Offense_Charges_;
    __ST211689_Layout __ND309650__Project(E_Criminal_Offense(__in,__cfg).Offense_Charges_Layout __PP309646) := TRANSFORM
      SELF.My_Crim_Date_ := KEL.era.ToDate(__PP309646.Date_First_Seen_);
      SELF := __PP309646;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE309215,__ND309650__Project(LEFT));
    SELF := __PP308990;
  END;
  EXPORT __ENH_Criminal_Offense_7 := PROJECT(__EE309395,__ND310027__Project(LEFT));
END;
