...
EXPORT B_U_C_C_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1898455 := __ENH_U_C_C_9;
  EXPORT __ST214289_Layout := RECORD
  ...
  END;
  EXPORT __ST214285_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST214289_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST214285_Layout __ND1898460__Project(B_U_C_C_9(__in,__cfg).__ST215200_Layout __PP1898456) := TRANSFORM
    __EE1898495 := __PP1898456.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE1898495),__ST214289_Layout),__NL(__EE1898495));
    SELF := __PP1898456;
  END;
  EXPORT __ENH_U_C_C_8 := PROJECT(__EE1898455,__ND1898460__Project(LEFT));
END;
