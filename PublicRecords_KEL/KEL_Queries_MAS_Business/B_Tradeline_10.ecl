...
EXPORT B_Tradeline_10(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE264985 := __E_Tradeline;
  EXPORT __ST215785_Layout := RECORD
  ...
  END;
  EXPORT __ST215778_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nint Ult_I_D_;
    KEL.typ.nint Org_I_D_;
    KEL.typ.nint Sele_I_D_;
    KEL.typ.nstr Account_Key_;
    KEL.typ.ndataset(__ST215785_Layout) Records_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST215778_Layout __ND265203__Project(E_Tradeline(__in,__cfg).Layout __PP264814) := TRANSFORM
    __EE264861 := __PP264814.Records_;
    __ST215785_Layout __ND265109__Project(E_Tradeline(__in,__cfg).Records_Layout __PP265105) := TRANSFORM
      SELF.Record_Date_ := KEL.era.ToDate(__PP265105.Date_First_Seen_);
      SELF := __PP265105;
    END;
    SELF.Records_ := __PROJECT(__EE264861,__ND265109__Project(LEFT));
    ...
    SELF := __PP264814;
  END;
  EXPORT __ENH_Tradeline_10 := PROJECT(__EE264985,__ND265203__Project(LEFT));
END;
