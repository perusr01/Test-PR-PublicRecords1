...
EXPORT B_Input_B_I_I_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1930280 := __ENH_Input_B_I_I_7;
  EXPORT __ST218761_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST218761_Layout __ND1930776__Project(B_Input_B_I_I_7(__in,__cfg).__ST218420_Layout __PP1930281) := TRANSFORM
    SELF.B___Inp_Addr_City_Flag_Value_ := FN_Compile(__cfg).FN_Is_Echo_Populated(__ECAST(KEL.typ.nstr,__PP1930281.B___Inp_Addr_City_));
    SELF.B___Inp_Addr_State_Flag_Value_ := FN_Compile(__cfg).FN_Is_Echo_Populated(__ECAST(KEL.typ.nstr,__PP1930281.B___Inp_Addr_State_));
    SELF.B___Inp_Addr_Zip_Flag_Value_ := FN_Compile(__cfg).FN_Is_Echo_Populated(__ECAST(KEL.typ.nstr,__PP1930281.B___Inp_Addr_Zip_));
    __CC13679 := '-99999';
    __CC13684 := '-99998';
    SELF.Bus_Input_Street_Clean_Value_ := MAP(__PP1930281.Addr_Not_Populated_=>__ECAST(KEL.typ.nstr,__CN(__CC13679)),__T(__AND(__AND(__AND(__AND(__AND(__AND(__OP2(__PP1930281.Bus_Input_Prim_Range_Clean_Value_,=,__CN(__CC13684)),__OP2(__PP1930281.Bus_Input_Pre_Dir_Clean_Value_,=,__CN(__CC13684))),__OP2(__PP1930281.Bus_Input_Prim_Name_Clean_Value_,=,__CN(__CC13684))),__OP2(__PP1930281.Bus_Input_Addr_Suffix_Clean_Value_,=,__CN(__CC13684))),__OP2(__PP1930281.Bus_Input_Post_Dir_Clean_Value_,=,__CN(__CC13684))),__OP2(__PP1930281.Bus_Input_Unit_Desig_Clean_Value_,=,__CN(__CC13684))),__OP2(__PP1930281.Bus_Input_Sec_Range_Clean_Value_,=,__CN(__CC13684))))=>__ECAST(KEL.typ.nstr,__CN(__CC13684)),__ECAST(KEL.typ.nstr,__OP2(__OP2(__OP2(__OP2(__OP2(__OP2(IF(__T(__OP2(__PP1930281.Bus_Input_Prim_Range_Clean_Value_,=,__CN(__CC13684))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP1930281.B___Inp_Cln_Addr_Prim_Rng_),+,__CN(' ')))),+,IF(__T(__OP2(__PP1930281.Bus_Input_Pre_Dir_Clean_Value_,=,__CN(__CC13684))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP1930281.B___Inp_Cln_Addr_Pre_Dir_),+,__CN(' '))))),+,IF(__T(__OP2(__PP1930281.Bus_Input_Prim_Name_Clean_Value_,=,__CN(__CC13684))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP1930281.B___Inp_Cln_Addr_Prim_Name_),+,__CN(' '))))),+,IF(__T(__OP2(__PP1930281.Bus_Input_Addr_Suffix_Clean_Value_,=,__CN(__CC13684))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP1930281.B___Inp_Cln_Addr_Sffx_),+,__CN(' '))))),+,IF(__T(__OP2(__PP1930281.Bus_Input_Post_Dir_Clean_Value_,=,__CN(__CC13684))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP1930281.B___Inp_Cln_Addr_Post_Dir_),+,__CN(' '))))),+,IF(__T(__OP2(__PP1930281.Bus_Input_Unit_Desig_Clean_Value_,=,__CN(__CC13684))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP1930281.B___Inp_Cln_Addr_Unit_Desig_),+,__CN(' '))))),+,IF(__T(__OP2(__PP1930281.Bus_Input_Sec_Range_Clean_Value_,=,__CN(__CC13684))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__FN1(TRIM,__PP1930281.B___Inp_Cln_Addr_Sec_Rng_))))));
    SELF := __PP1930281;
  END;
  EXPORT __ENH_Input_B_I_I_6 := PROJECT(__EE1930280,__ND1930776__Project(LEFT));
END;
