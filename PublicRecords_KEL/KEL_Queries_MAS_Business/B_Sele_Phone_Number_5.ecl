...
EXPORT B_Sele_Phone_Number_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1989073 := __ENH_Sele_Phone_Number_6;
  EXPORT __ST206887_Layout := RECORD
  ...
  END;
  EXPORT __ST206849_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST206887_Layout) Data_Sources_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST206849_Layout __ND1989078__Project(B_Sele_Phone_Number_6(__in,__cfg).__ST210247_Layout __PP1989074) := TRANSFORM
    __EE1989127 := __PP1989074.Data_Sources_;
    SELF.Data_Sources_ := __BN(PROJECT(__T(__EE1989127),__ST206887_Layout),__NL(__EE1989127));
    SELF := __PP1989074;
  END;
  EXPORT __ENH_Sele_Phone_Number_5 := PROJECT(__EE1989073,__ND1989078__Project(LEFT));
END;
