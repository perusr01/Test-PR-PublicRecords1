...
EXPORT B_U_C_C_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2510440 := __ENH_U_C_C_4;
  EXPORT __ST195414_Layout := RECORD
  ...
  END;
  EXPORT __ST195410_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr T_M_S_I_D_;
    KEL.typ.ndataset(__ST195414_Layout) Sub_Filing_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST195410_Layout __ND2510679__Project(B_U_C_C_4(__in,__cfg).__ST203172_Layout __PP2510441) := TRANSFORM
    __EE2510482 := __PP2510441.Sub_Filing_;
    SELF.Sub_Filing_ := __BN(PROJECT(__T(__EE2510482),__ST195414_Layout),__NL(__EE2510482));
    SELF.Active_Status_ := __OP2(__PP2510441.Best_Inferred_Status_,=,__CN('1'));
    SELF := __PP2510441;
  END;
  EXPORT __ENH_U_C_C_3 := PROJECT(__EE2510440,__ND2510679__Project(LEFT));
END;
