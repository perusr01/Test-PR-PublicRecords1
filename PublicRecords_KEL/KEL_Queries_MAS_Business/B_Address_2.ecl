...
EXPORT B_Address_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2510770 := __ENH_Address_3;
  SHARED __EE801484 := __E_Zip_Code;
  SHARED __ST802217_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  __JC2511295(B_Address_5(__in,__cfg).__ST203260_Layout __EE2510770, E_Zip_Code(__in,__cfg).Layout __EE801484) := __EEQP(__EE2510770.Z_I_P5_,__EE801484.UID);
  __ST802217_Layout __JT2511295(B_Address_5(__in,__cfg).__ST203260_Layout __l, E_Zip_Code(__in,__cfg).Layout __r) := TRANSFORM
    SELF.U_I_D__1_ := __r.UID;
    SELF.Data_Sources__1_ := __r.Data_Sources_;
    SELF := __l;
    SELF := __r;
  END;
  SHARED __EE2511296 := JOIN(__EE2510770,__EE801484,__JC2511295(LEFT,RIGHT),__JT2511295(LEFT,RIGHT),LEFT OUTER,HASH);
  EXPORT __ST175150_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Primary_Range_;
    KEL.typ.nstr Predirectional_;
    KEL.typ.nstr Primary_Name_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST175150_Layout __ND2511912__Project(__ST802217_Layout __PP2510778) := TRANSFORM
    __BS2511142 := __T(__PP2510778.Address_Type_);
    SELF.Is_P_O_Box_A_D_V_O_ := EXISTS(__BS2511142(__T(__OP2(__T(__PP2510778.Address_Type_).Address_Type_Code_,=,__CN('9')))));
    SELF.Is_P_O_Box_Zip_ := __OP2(__PP2510778.Zip_Class_,=,__CN('P'));
    SELF := __PP2510778;
  END;
  EXPORT __ENH_Address_2 := PROJECT(__EE2511296,__ND2511912__Project(LEFT));
END;
