...
EXPORT B_Criminal_Offense_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1929753 := __ENH_Criminal_Offense_7;
  EXPORT __ST209057_Layout := RECORD
  ...
  END;
  EXPORT __ST209010_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST209057_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST209010_Layout __ND1930131__Project(B_Criminal_Offense_7(__in,__cfg).__ST211642_Layout __PP1929754) := TRANSFORM
    __EE1929914 := __PP1929754.Offense_Charges_;
    __ST209057_Layout __ND1930118__Project(B_Criminal_Offense_7(__in,__cfg).__ST211689_Layout __PP1929915) := TRANSFORM
      __CC14101 := '-99998';
      SELF.Valid_Date_ := IF(__T(__FN1(KEL.Routines.IsValidDate,__PP1929915.My_Crim_Date_)),__ECAST(KEL.typ.nstr,__FN2(KEL.Routines.DateToString,__PP1929915.My_Crim_Date_,__CN('%Y%m%d'))),__ECAST(KEL.typ.nstr,__CN(__CC14101)));
      SELF := __PP1929915;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE1929914,__ND1930118__Project(LEFT));
    SELF := __PP1929754;
  END;
  EXPORT __ENH_Criminal_Offense_6 := PROJECT(__EE1929753,__ND1930131__Project(LEFT));
END;
