...
EXPORT B_Criminal_Offense_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2008896 := __ENH_Criminal_Offense_3;
  ...
  END;
  EXPORT __ST159708_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST159755_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST159708_Layout __ND2009314__Project(B_Criminal_Offense_3(__in,__cfg).__ST165277_Layout __PP2008897) := TRANSFORM
    __EE2009057 := __PP2008897.Offense_Charges_;
    __ST159755_Layout __ND2009291__Project(B_Criminal_Offense_3(__in,__cfg).__ST165324_Layout __PP2009058) := TRANSFORM
      SELF.Is_Arrest_ := __OP2(__PP2009058.Data_Type_,=,__CN('5'));
      SELF.Is_Non_Felony_Records_Non_F_C_R_A_ := __AND(__NOT(__PP2009058.Dismissed_Charges_),__NOT(__OP2(__PP2009058.Offense_Score_,=,__CN('F'))));
      SELF := __PP2009058;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE2009057,__ND2009291__Project(LEFT));
    SELF := __PP2008897;
  END;
  EXPORT __ENH_Criminal_Offense_2 := PROJECT(__EE2008896,__ND2009314__Project(LEFT));
END;
