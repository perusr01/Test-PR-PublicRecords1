...
EXPORT B_Property_Event_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE227820 := __E_Property_Event;
  EXPORT __ST179173_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST179173_Layout __ND227888__Project(E_Property_Event(__in,__cfg).Layout __PP227483) := TRANSFORM
    SELF.Dt_First_Seen_ := KEL.era.ToDate(__PP227483.Date_First_Seen_);
    SELF := __PP227483;
  END;
  EXPORT __ENH_Property_Event_8 := PROJECT(__EE227820,__ND227888__Project(LEFT));
END;
