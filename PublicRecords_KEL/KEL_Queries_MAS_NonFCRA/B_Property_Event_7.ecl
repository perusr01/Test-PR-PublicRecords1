...
EXPORT B_Property_Event_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1600545 := __ENH_Property_Event_8;
  EXPORT __ST178035_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST178035_Layout __ND1600550__Project(B_Property_Event_8(__in,__cfg).__ST179173_Layout __PP1600546) := TRANSFORM
    SELF.Dt_Last_Seen_ := KEL.era.ToDate(__PP1600546.Date_Last_Seen_);
    SELF := __PP1600546;
  END;
  EXPORT __ENH_Property_Event_7 := PROJECT(__EE1600545,__ND1600550__Project(LEFT));
END;
