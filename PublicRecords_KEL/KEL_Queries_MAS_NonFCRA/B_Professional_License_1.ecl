...
EXPORT B_Professional_License_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE3209537 := __ENH_Professional_License_2;
  EXPORT __ST158441_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  EXPORT __ENH_Professional_License_1 := PROJECT(__EE3209537,__ST158441_Layout);
END;
