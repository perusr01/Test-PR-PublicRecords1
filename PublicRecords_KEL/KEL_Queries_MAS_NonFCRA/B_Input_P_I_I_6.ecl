...
EXPORT B_Input_P_I_I_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1601911 := __ENH_Input_P_I_I_7;
  EXPORT __ST182306_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST182306_Layout __ND1602479__Project(B_Input_P_I_I_8(__in,__cfg).__ST178342_Layout __PP1601912) := TRANSFORM
    __CC13664 := '-99999';
    SELF.Input_First_Name_Value_ := FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP1601912.P___Inp_Name_First_),__ECAST(KEL.typ.nstr,__CN(__CC13664)));
    SELF.Input_Last_Name_Value_ := FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP1601912.P___Inp_Name_Last_),__ECAST(KEL.typ.nstr,__CN(__CC13664)));
    SELF.Input_Middle_Name_Value_ := FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP1601912.P___Inp_Name_Mid_),__ECAST(KEL.typ.nstr,__CN(__CC13664)));
    SELF.P___Inp_Addr_ := __OP2(IF(__T(__NT(__PP1601912.P___Inp_Addr_Line1_)),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__PP1601912.P___Inp_Addr_Line1_,+,__CN(' ')))),+,IF(__T(__NT(__PP1601912.P___Inp_Addr_Line2_)),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP1601912.P___Inp_Addr_Line2_)));
    SELF := __PP1601912;
  END;
  EXPORT __ENH_Input_P_I_I_6 := PROJECT(__EE1601911,__ND1602479__Project(LEFT));
END;
