...
EXPORT B_Criminal_Offense_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1666812 := __ENH_Criminal_Offense_5;
  EXPORT __ST169662_Layout := RECORD
  ...
  END;
  EXPORT __ST169615_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST169662_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST169615_Layout __ND1666817__Project(B_Criminal_Offense_5(__in,__cfg).__ST172862_Layout __PP1666813) := TRANSFORM
    __EE1666973 := __PP1666813.Offense_Charges_;
    __ST169662_Layout __ND1666978__Project(B_Criminal_Offense_5(__in,__cfg).__ST172909_Layout __PP1666974) := TRANSFORM
      ...
      SELF.Age_In_Days_ := FN_Compile(__cfg).FN_A_B_S_D_A_Y_S_B_E_T_W_E_E_N(__ECAST(KEL.typ.nkdate,__PP1666974.Criminal_Date_),__ECAST(KEL.typ.nkdate,__CC13319));
      SELF.Is_Criminal_Count_Non_F_C_R_A_ := __NOT(__PP1666974.Dismissed_Charges_);
      SELF := __PP1666974;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE1666973,__ND1666978__Project(LEFT));
    SELF := __PP1666813;
  END;
  EXPORT __ENH_Criminal_Offense_4 := PROJECT(__EE1666812,__ND1666817__Project(LEFT));
END;
