...
EXPORT B_Criminal_Offense_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE229731 := __E_Criminal_Offense;
  ...
  EXPORT __ST177083_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST177130_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST177083_Layout __ND230363__Project(E_Criminal_Offense(__in,__cfg).Layout __PP229326) := TRANSFORM
    __EE229551 := __PP229326.Offense_Charges_;
    __ST177130_Layout __ND229986__Project(E_Criminal_Offense(__in,__cfg).Offense_Charges_Layout __PP229982) := TRANSFORM
      SELF.My_Crim_Date_ := KEL.era.ToDate(__PP229982.Date_First_Seen_);
      SELF := __PP229982;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE229551,__ND229986__Project(LEFT));
    SELF := __PP229326;
  END;
  EXPORT __ENH_Criminal_Offense_7 := PROJECT(__EE229731,__ND230363__Project(LEFT));
END;
