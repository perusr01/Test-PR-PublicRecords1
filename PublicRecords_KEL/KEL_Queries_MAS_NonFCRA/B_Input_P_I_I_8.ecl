...
EXPORT B_Input_P_I_I_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE220904 := __E_Input_P_I_I;
  EXPORT __ST178342_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST178342_Layout __ND1584776__Project(E_Input_P_I_I(__in,__cfg).Layout __PP220226) := TRANSFORM
    __CC13669 := '-99998';
    __CC13664 := '-99999';
    SELF.Input_S_S_N_Clean_Value_ := IF(__T(__OP2(__FN1(LENGTH,__ECAST(KEL.typ.nstr,__ECAST(KEL.typ.nint,__PP220226.P___Inp_Cln_S_S_N_))),>,__CN(9))),__ECAST(KEL.typ.nstr,__CN(__CC13669)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank2_Fields(__ECAST(KEL.typ.nstr,__PP220226.P___Inp_S_S_N_),__ECAST(KEL.typ.nstr,__CN(__CC13664)),__ECAST(KEL.typ.nstr,__PP220226.P___Inp_Cln_S_S_N_),__ECAST(KEL.typ.nstr,__CN(__CC13669)))));
    SELF := __PP220226;
  END;
  EXPORT __ENH_Input_P_I_I_8 := PROJECT(__EE220904,__ND1584776__Project(LEFT));
END;
