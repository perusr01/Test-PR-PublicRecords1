...
EXPORT B_Professional_License_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2551279 := __ENH_Professional_License_3;
  EXPORT __ST163900_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  EXPORT __ENH_Professional_License_2 := PROJECT(__EE2551279,__ST163900_Layout);
END;
