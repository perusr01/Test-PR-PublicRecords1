...
EXPORT B_Input_P_I_I_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1667275 := __ENH_Input_P_I_I_5;
  EXPORT __ST183070_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST183070_Layout __ND1667932__Project(B_Input_P_I_I_5(__in,__cfg).__ST182651_Layout __PP1667276) := TRANSFORM
    __CC13664 := '-99999';
    __CC13669 := '-99998';
    SELF.Input_D_O_B_Clean_Value_ := FN_Compile(__cfg).FN_Is_Blank2_Fields(__ECAST(KEL.typ.nstr,__PP1667276.P___Inp_D_O_B_),__ECAST(KEL.typ.nstr,__CN(__CC13664)),__ECAST(KEL.typ.nstr,__ECAST(KEL.typ.nstr,__PP1667276.P___Inp_Cln_D_O_B_)),__ECAST(KEL.typ.nstr,__CN(__CC13669)));
    SELF.Input_First_Name_Clean_Value_ := MAP(__PP1667276.P___Inp_Val_Name_Bogus_Flag_ = (KEL.typ.str)1=>__ECAST(KEL.typ.nstr,__CN(__CC13669)),__ECAST(KEL.typ.nstr,IF(__PP1667276.Name_Not_Populated_,__ECAST(KEL.typ.nstr,__CN(__CC13664)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP1667276.P___Inp_Cln_Name_First_),__ECAST(KEL.typ.nstr,__CN(__CC13669)))))));
    SELF.Input_Home_Phone_Clean_Value_ := FN_Compile(__cfg).FN_Is_Blank2_Fields(__ECAST(KEL.typ.nstr,__PP1667276.P___Inp_Phone_Home_),__ECAST(KEL.typ.nstr,__CN(__CC13664)),__ECAST(KEL.typ.nstr,__PP1667276.P___Inp_Cln_Phone_Home_),__ECAST(KEL.typ.nstr,__CN(__CC13669)));
    SELF.Input_Last_Name_Clean_Value_ := MAP(__PP1667276.P___Inp_Val_Name_Bogus_Flag_ = (KEL.typ.str)1=>__ECAST(KEL.typ.nstr,__CN(__CC13669)),__ECAST(KEL.typ.nstr,IF(__PP1667276.Name_Not_Populated_,__ECAST(KEL.typ.nstr,__CN(__CC13664)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP1667276.P___Inp_Cln_Name_Last_),__ECAST(KEL.typ.nstr,__CN(__CC13669)))))));
    SELF.Input_Primary_Name_Clean_Value_ := MAP(__PP1667276.Addr_Not_Populated_=>__ECAST(KEL.typ.nstr,__CN(__CC13664)),__T(__PP1667276.City_State_Zip_Not_Populated_)=>__ECAST(KEL.typ.nstr,__CN(__CC13669)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP1667276.P___Inp_Cln_Addr_Prim_Name_),__ECAST(KEL.typ.nstr,__CN(__CC13669)))));
    SELF.Input_Primary_Range_Clean_Value_ := MAP(__PP1667276.Addr_Not_Populated_=>__ECAST(KEL.typ.nstr,__CN(__CC13664)),__T(__PP1667276.City_State_Zip_Not_Populated_)=>__ECAST(KEL.typ.nstr,__CN(__CC13669)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP1667276.P___Inp_Cln_Addr_Prim_Rng_),__ECAST(KEL.typ.nstr,__CN(__CC13669)))));
    SELF.Input_Zip5_Clean_Value_ := MAP(__T(__AND(__CN(__PP1667276.P___Inp_Addr_Zip_Flag_Value_ = '0'),__OR(__CN(__PP1667276.Addr_Not_Populated_),__PP1667276.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13664)),__T(__AND(__CN(__PP1667276.P___Inp_Addr_Zip_Flag_Value_ = '1'),__OR(__CN(__PP1667276.Addr_Not_Populated_),__PP1667276.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13669)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP1667276.P___Inp_Cln_Addr_Zip5_),__ECAST(KEL.typ.nstr,__CN(__CC13669)))));
    SELF := __PP1667276;
  END;
  EXPORT __ENH_Input_P_I_I_4 := PROJECT(__EE1667275,__ND1667932__Project(LEFT));
END;
