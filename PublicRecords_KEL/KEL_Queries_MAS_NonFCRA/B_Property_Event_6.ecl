...
EXPORT B_Property_Event_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1641379 := __ENH_Property_Event_7;
  EXPORT __ST176878_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST176878_Layout __ND1641733__Project(B_Property_Event_7(__in,__cfg).__ST178035_Layout __PP1641380) := TRANSFORM
    ...
    SELF.Is_Current_Assessment_Record_ := __AND(__PP1641380.Is_Assessment_,__OP2(FN_Compile(__cfg).FN_A_B_S_Y_E_A_R_S_B_E_T_W_E_E_N(__ECAST(KEL.typ.nkdate,KEL.era.ToDate(__PP1641380.Date_First_Seen_)),__ECAST(KEL.typ.nkdate,__CC13407)),<=,__CN(1)));
    ...
    SELF.Property_Purchase_Record_ := __OR(__OP2(__PP1641380.Document_Type_Code_,IN,__CN(__CC72707)),__OP2(__PP1641380.Sale_Price_,>,__CN(0)));
    SELF := __PP1641380;
  END;
  EXPORT __ENH_Property_Event_6 := PROJECT(__EE1641379,__ND1641733__Project(LEFT));
END;
