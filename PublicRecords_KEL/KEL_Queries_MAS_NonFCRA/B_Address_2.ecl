...
EXPORT B_Address_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE2006143 := __ENH_Address_3;
  EXPORT __ST159037_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST159037_Layout __ND2005900__Project(B_Address_3(__in,__cfg).__ST164585_Layout __PP2005098) := TRANSFORM
    __EE2005895 := __PP2005098.Bestchild_Advo_;
    SELF.College_Flag_ := (__T(__EE2005895))[1].College_Indicator_;
    __EE2005910 := __PP2005098.Bestchild_Advo_;
    SELF.Do_Not_Deliver_Flag_ := (__T(__EE2005910))[1].Do_Not_Deliver_Indicator_;
    __EE2005924 := __PP2005098.Bestchild_Advo_;
    SELF.Drop_Indicator_Flag_ := (__T(__EE2005924))[1].Drop_Indicator_;
    __EE2005938 := __PP2005098.Bestchild_Advo_;
    SELF.Res_Bus_Flag_ := (__T(__EE2005938))[1].Residential_Or_Business_Indicator_;
    __EE2005952 := __PP2005098.Bestchild_Advo_;
    SELF.Seasonal_Delivery_Flag_ := (__T(__EE2005952))[1].Seasonal_Delivery_Indicator_;
    __EE2005966 := __PP2005098.Bestchild_Advo_;
    SELF.Style_Flag_ := (__T(__EE2005966))[1].Style_Code_;
    __EE2005980 := __PP2005098.Bestchild_Advo_;
    SELF.Throw_Back_Flag_ := (__T(__EE2005980))[1].Throw_Back_Indicator_;
    __EE2005994 := __PP2005098.Bestchild_Advo_;
    SELF.Vacant_Flag_ := (__T(__EE2005994))[1].Vacancy_Indicator_;
    SELF := __PP2005098;
  END;
  EXPORT __ENH_Address_2 := PROJECT(__EE2006143,__ND2005900__Project(LEFT));
END;
