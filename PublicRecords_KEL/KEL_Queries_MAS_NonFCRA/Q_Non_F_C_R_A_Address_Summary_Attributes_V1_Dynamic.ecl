...
EXPORT Q_Non_F_C_R_A_Address_Summary_Attributes_V1_Dynamic(KEL.typ.str __PPrimaryName_in, KEL.typ.str __PPrimaryRange_in, KEL.typ.str __PZIP5_in, DATASET(RECORDOF(PublicRecords_KEL.ECL_Functions.Layouts.LayoutInputPII)) __PInputPIIDataset, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED __EE4006274 := __ENH_Address_Summary;
  SHARED __EE4006351 := __EE4006274(__T(__AND(__OP2(__EE4006274.Primary_Name_,=,__CN(__PPrimaryName_in)),__AND(__OP2(__EE4006274.Primary_Range_,=,__CN(__PPrimaryRange_in)),__OP2(__EE4006274.Zip_,=,__CN(__PZIP5_in))))));
  SHARED __ST83727_Layout := RECORD
  ...
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(TABLE(PROJECT(__EE4006351,__ST83727_Layout),{KEL.typ.int __RecordCount := SUM(GROUP,__RecordCount),KEL.typ.epoch Archive___Date_ := KEL.era.SimpleRoll(GROUP,Archive___Date_,MIN,FALSE),KEL.typ.epoch Date_First_Seen_ := KEL.era.SimpleRoll(GROUP,Date_First_Seen_,MIN,FALSE),KEL.typ.epoch Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Date_Last_Seen_,MAX,FALSE),KEL.typ.epoch Hybrid_Archive_Date_ := KEL.era.SimpleRoll(GROUP,Hybrid_Archive_Date_,MIN,FALSE),KEL.typ.epoch Vault_Date_Last_Seen_ := KEL.era.SimpleRoll(GROUP,Vault_Date_Last_Seen_,MAX,NMAX),P_I___Src_W_Inp_F_L_A_List_Ev_,P_I___Src_W_Inp_F_L_A_Emrg_Dt_List_Ev_,P_I___Src_W_Inp_F_L_A_Last_Dt_List_Ev_,P_I___Src_W_Inp_A_D_List_Ev_,P_I___Src_W_Inp_A_D_Emrg_Dt_List_Ev_,P_I___Src_W_Inp_A_D_Last_Dt_List_Ev_},P_I___Src_W_Inp_F_L_A_List_Ev_,P_I___Src_W_Inp_F_L_A_Emrg_Dt_List_Ev_,P_I___Src_W_Inp_F_L_A_Last_Dt_List_Ev_,P_I___Src_W_Inp_A_D_List_Ev_,P_I___Src_W_Inp_A_D_Emrg_Dt_List_Ev_,P_I___Src_W_Inp_A_D_Last_Dt_List_Ev_,MERGE),__ST83727_Layout));
