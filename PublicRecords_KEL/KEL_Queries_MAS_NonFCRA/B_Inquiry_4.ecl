...
EXPORT B_Inquiry_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1668271 := __ENH_Inquiry_5;
  EXPORT __ST170298_Layout := RECORD
  ...
  END;
  EXPORT __ST170271_Layout := RECORD
    KEL.typ.nuid UID;
    KEL.typ.nstr Transaction_I_D_;
    ...
    KEL.typ.ndataset(__ST170298_Layout) Person_Info_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST170271_Layout __ND1668609__Project(B_Inquiry_9(__in,__cfg).__ST179320_Layout __PP1668272) := TRANSFORM
    __EE1668345 := __PP1668272.Person_Info_;
    __ST170298_Layout __ND1668350__Project(E_Inquiry(__in,__cfg).Person_Info_Layout __PP1668346) := TRANSFORM
      SELF.Transaction_I_D_ := __PP1668272.Transaction_I_D_;
      SELF := __PP1668346;
    END;
    SELF.Person_Info_ := __PROJECT(__EE1668345,__ND1668350__Project(LEFT));
    ...
    SELF.Is_Valid_Velocity_Inquiry_Non_F_C_R_A_ := __AND(__AND(__AND(__AND(__AND(__OP2(__PP1668272.Agein_Days_,<=,__CN(365)),__CN(NOT (__PP1668272.Is_Collection_))),__CN(NOT (__PP1668272.Is_Batch_Monitoring_Method_))),__PP1668272.Is_Product_Code_Ok_),__CN(NOT (__PP1668272.Inquiry_Function_Description_ IN __CC40410))),__PP1668272.Is_Non_Fcra_Ok_);
    SELF := __PP1668272;
  END;
  EXPORT __ENH_Inquiry_4 := PROJECT(__EE1668271,__ND1668609__Project(LEFT));
END;
