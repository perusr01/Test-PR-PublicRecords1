...
EXPORT B_Input_P_I_I_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE291283 := __ENH_Input_P_I_I_6;
  EXPORT __ST150962_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST150962_Layout __ND291990__Project(B_Input_P_I_I_6(__in,__cfg).__ST151655_Layout __PP291284) := TRANSFORM
    SELF.Clean_City_State_Zip_Not_Populated_ := FN_Compile(__cfg).FN_City_State_Zip_Not_Populated_Check(__ECAST(KEL.typ.nstr,__PP291284.P___Inp_Cln_Addr_City_),__ECAST(KEL.typ.nstr,__PP291284.P___Inp_Cln_Addr_State_),__ECAST(KEL.typ.nstr,__PP291284.P___Inp_Cln_Addr_Zip5_));
    ...
    __CC13664 := '-99999';
    __CC13669 := '-99998';
    SELF.Input_City_Clean_Value_ := MAP(__T(__AND(__CN(__PP291284.P___Inp_Addr_City_Flag_Value_ = '0'),__OR(__CN(__PP291284.Addr_Not_Populated_),__PP291284.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13664)),__T(__AND(__CN(__PP291284.P___Inp_Addr_City_Flag_Value_ = '1'),__OR(__CN(__PP291284.Addr_Not_Populated_),__PP291284.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13669)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP291284.P___Inp_Cln_Addr_City_),__ECAST(KEL.typ.nstr,__CN(__CC13669)))));
    SELF.Input_State_Clean_Value_ := MAP(__T(__AND(__CN(__PP291284.P___Inp_Addr_State_Flag_Value_ = '0'),__OR(__CN(__PP291284.Addr_Not_Populated_),__PP291284.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13664)),__T(__AND(__CN(__PP291284.P___Inp_Addr_State_Flag_Value_ = '1'),__OR(__CN(__PP291284.Addr_Not_Populated_),__PP291284.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13669)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP291284.P___Inp_Cln_Addr_State_),__ECAST(KEL.typ.nstr,__CN(__CC13669)))));
    SELF.Input_Zip4_Clean_Value_ := MAP(__T(__AND(__CN(__PP291284.P___Inp_Addr_Zip_Flag_Value_ = '0'),__OR(__CN(__PP291284.Addr_Not_Populated_),__PP291284.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13664)),__T(__AND(__CN(__PP291284.P___Inp_Addr_Zip_Flag_Value_ = '1'),__OR(__CN(__PP291284.Addr_Not_Populated_),__PP291284.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13669)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP291284.P___Inp_Cln_Addr_Zip4_),__ECAST(KEL.typ.nstr,__CN(__CC13669)))));
    SELF.Input_Zip5_Clean_Value_ := MAP(__T(__AND(__CN(__PP291284.P___Inp_Addr_Zip_Flag_Value_ = '0'),__OR(__CN(__PP291284.Addr_Not_Populated_),__PP291284.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13664)),__T(__AND(__CN(__PP291284.P___Inp_Addr_Zip_Flag_Value_ = '1'),__OR(__CN(__PP291284.Addr_Not_Populated_),__PP291284.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13669)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP291284.P___Inp_Cln_Addr_Zip5_),__ECAST(KEL.typ.nstr,__CN(__CC13669)))));
    SELF.P___Inp_Cln_Addr_St_Flag_Value_ := FN_Compile(__cfg).FN_Is_Clean_Populated(__ECAST(KEL.typ.nstr,__PP291284.Input_Street_Clean_Value_),__ECAST(KEL.typ.nstr,__CN(__CC13664)),__ECAST(KEL.typ.nstr,__CN(__CC13669)));
    SELF.Targus_Gateway_I_P_ := FN_Compile(__cfg).FN_G_E_T___T_A_R_G_U_S___U_R_L(__ECAST(KEL.typ.nstr,__CN('DummyValue')));
    SELF := __PP291284;
  END;
  EXPORT __ENH_Input_P_I_I_5 := PROJECT(__EE291283,__ND291990__Project(LEFT));
END;
