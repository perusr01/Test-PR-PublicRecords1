...
EXPORT B_Address_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE389100 := __ENH_Address_3;
  EXPORT __ST146575_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST146575_Layout __ND388949__Project(B_Address_3(__in,__cfg).__ST148197_Layout __PP388288) := TRANSFORM
    __EE388944 := __PP388288.Bestchild_Advo_;
    SELF.Res_Bus_Flag_ := (__T(__EE388944))[1].Residential_Or_Business_Indicator_;
    SELF := __PP388288;
  END;
  EXPORT __ENH_Address_2 := PROJECT(__EE389100,__ND388949__Project(LEFT));
END;
