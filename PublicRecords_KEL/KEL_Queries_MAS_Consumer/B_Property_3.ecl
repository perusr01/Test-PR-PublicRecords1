...
EXPORT B_Property_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE388085 := __ENH_Property_4;
  EXPORT __ST149551_Layout := RECORD
  ...
  END;
  EXPORT __ST149533_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST149551_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST149533_Layout __ND388090__Project(B_Property_4(__in,__cfg).__ST150514_Layout __PP388086) := TRANSFORM
    __EE388129 := __PP388086.Automated_Valuation_Model_;
    SELF.Automated_Valuation_Model_ := __BN(PROJECT(__T(__EE388129),__ST149551_Layout),__NL(__EE388129));
    SELF := __PP388086;
  END;
  EXPORT __ENH_Property_3 := PROJECT(__EE388085,__ND388090__Project(LEFT));
END;
