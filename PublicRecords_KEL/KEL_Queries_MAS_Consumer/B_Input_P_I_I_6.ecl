...
EXPORT B_Input_P_I_I_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE289631 := __ENH_Input_P_I_I_7;
  EXPORT __ST151655_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST151655_Layout __ND290379__Project(B_Input_P_I_I_7(__in,__cfg).__ST152130_Layout __PP289632) := TRANSFORM
    __CC13664 := '-99999';
    __CC13669 := '-99998';
    SELF.Input_Street_Clean_Value_ := MAP(__PP289632.Addr_Not_Populated_=>__ECAST(KEL.typ.nstr,__CN(__CC13664)),__T(__AND(__AND(__AND(__AND(__AND(__AND(__OP2(__PP289632.Input_Primary_Range_Clean_Value_,=,__CN(__CC13669)),__OP2(__PP289632.Input_Pre_Direction_Clean_Value_,=,__CN(__CC13669))),__OP2(__PP289632.Input_Primary_Name_Clean_Value_,=,__CN(__CC13669))),__OP2(__PP289632.Input_Address_Suffix_Clean_Value_,=,__CN(__CC13669))),__OP2(__PP289632.Input_Post_Direction_Clean_Value_,=,__CN(__CC13669))),__OP2(__PP289632.Input_Unit_Desig_Clean_Value_,=,__CN(__CC13669))),__OP2(__PP289632.Input_Secondary_Range_Clean_Value_,=,__CN(__CC13669))))=>__ECAST(KEL.typ.nstr,__CN(__CC13669)),__ECAST(KEL.typ.nstr,__OP2(__OP2(__OP2(__OP2(__OP2(__OP2(IF(__T(__OP2(__PP289632.Input_Primary_Range_Clean_Value_,=,__CN(__CC13669))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP289632.P___Inp_Cln_Addr_Prim_Rng_),+,__CN(' ')))),+,IF(__T(__OP2(__PP289632.Input_Pre_Direction_Clean_Value_,=,__CN(__CC13669))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP289632.P___Inp_Cln_Addr_Pre_Dir_),+,__CN(' '))))),+,IF(__T(__OP2(__PP289632.Input_Primary_Name_Clean_Value_,=,__CN(__CC13669))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP289632.P___Inp_Cln_Addr_Prim_Name_),+,__CN(' '))))),+,IF(__T(__OP2(__PP289632.Input_Address_Suffix_Clean_Value_,=,__CN(__CC13669))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP289632.P___Inp_Cln_Addr_Sffx_),+,__CN(' '))))),+,IF(__T(__OP2(__PP289632.Input_Post_Direction_Clean_Value_,=,__CN(__CC13669))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP289632.P___Inp_Cln_Addr_Post_Dir_),+,__CN(' '))))),+,IF(__T(__OP2(__PP289632.Input_Unit_Desig_Clean_Value_,=,__CN(__CC13669))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__OP2(__FN1(TRIM,__PP289632.P___Inp_Cln_Addr_Unit_Desig_),+,__CN(' '))))),+,IF(__T(__OP2(__PP289632.Input_Secondary_Range_Clean_Value_,=,__CN(__CC13669))),__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__FN1(TRIM,__PP289632.P___Inp_Cln_Addr_Sec_Rng_))))));
    SELF.P___Inp_Addr_City_Flag_Value_ := FN_Compile(__cfg).FN_Is_Echo_Populated(__ECAST(KEL.typ.nstr,__PP289632.P___Inp_Addr_City_));
    SELF.P___Inp_Addr_State_Flag_Value_ := FN_Compile(__cfg).FN_Is_Echo_Populated(__ECAST(KEL.typ.nstr,__PP289632.P___Inp_Addr_State_));
    SELF.P___Inp_Addr_Zip_Flag_Value_ := FN_Compile(__cfg).FN_Is_Echo_Populated(__ECAST(KEL.typ.nstr,__PP289632.P___Inp_Addr_Zip_));
    SELF := __PP289632;
  END;
  EXPORT __ENH_Input_P_I_I_6 := PROJECT(__EE289631,__ND290379__Project(LEFT));
END;
