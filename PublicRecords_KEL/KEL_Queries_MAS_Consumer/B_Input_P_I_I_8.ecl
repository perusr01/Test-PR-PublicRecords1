...
EXPORT B_Input_P_I_I_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE287741 := __ENH_Input_P_I_I_9;
  EXPORT __ST152511_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST152511_Layout __ND287746__Project(B_Input_P_I_I_9(__in,__cfg).__ST152793_Layout __PP287742) := TRANSFORM
    SELF.Addr_Not_Populated_ := FN_Compile(__cfg).FN_Is_Not_Enough_To_Clean(__ECAST(KEL.typ.nstr,__PP287742.P___Inp_Addr_));
    SELF.City_State_Zip_Not_Populated_ := FN_Compile(__cfg).FN_City_State_Zip_Not_Populated_Check(__ECAST(KEL.typ.nstr,__PP287742.P___Inp_Addr_City_),__ECAST(KEL.typ.nstr,__PP287742.P___Inp_Addr_State_),__ECAST(KEL.typ.nstr,__PP287742.P___Inp_Addr_Zip_));
    SELF := __PP287742;
  END;
  EXPORT __ENH_Input_P_I_I_8 := PROJECT(__EE287741,__ND287746__Project(LEFT));
END;
