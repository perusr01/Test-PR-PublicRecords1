...
EXPORT B_Inquiry_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE289566 := __E_Inquiry;
  EXPORT __ST152290_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST152290_Layout __ND289499__Project(E_Inquiry(__in,__cfg).Layout __PP160666) := TRANSFORM
    __EE289492 := __PP160666.Bus_Intel_;
    SELF.Inquiry_Sub_Market_ := __DEFAULT((__T(__EE289492))[1].Sub_Market_,'');
    SELF := __PP160666;
  END;
  EXPORT __ENH_Inquiry_7 := PROJECT(__EE289566,__ND289499__Project(LEFT));
END;
