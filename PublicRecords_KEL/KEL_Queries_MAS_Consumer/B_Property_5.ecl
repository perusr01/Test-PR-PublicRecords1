...
EXPORT B_Property_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE166568 := __E_Property;
  EXPORT __ST151322_Layout := RECORD
  ...
  END;
  EXPORT __ST151304_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST151322_Layout) Automated_Valuation_Model_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST151304_Layout __ND166806__Project(E_Property(__in,__cfg).Layout __PP166379) := TRANSFORM
    __EE166449 := __PP166379.Automated_Valuation_Model_;
    __ST151322_Layout __ND166726__Project(E_Property(__in,__cfg).Automated_Valuation_Model_Layout __PP166722) := TRANSFORM
      SELF.A_V_M_Value_Date_ := KEL.era.ToDate(__PP166722.Date_First_Seen_);
      SELF := __PP166722;
    END;
    SELF.Automated_Valuation_Model_ := __PROJECT(__EE166449,__ND166726__Project(LEFT));
    SELF := __PP166379;
  END;
  EXPORT __ENH_Property_5 := PROJECT(__EE166568,__ND166806__Project(LEFT));
END;
