...
EXPORT B_Professional_License_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1149457 := __ENH_Professional_License_5;
  ...
  END;
  SHARED __ST164581_Layout __ND1149641__Project(B_Professional_License_5(__in,__cfg).__ST166484_Layout __PP1149458) := TRANSFORM
    SELF.Is_Active_ := __OP2(__PP1149458.Max_Expire_Date_,>,__PP1149458.B_U_I_L_D___D_A_T_E_);
    SELF.Valid_Professional_License_ := __AND(__OP2(__PP1149458.License_Number_,<>,__CN('')),__OR(__OP2(__PP1149458.Max_Issue_Date_,<,__PP1149458.B_U_I_L_D___D_A_T_E_),__NT(__PP1149458.Max_Issue_Date_)));
    SELF := __PP1149458;
  END;
  EXPORT __ENH_Professional_License_4 := PROJECT(__EE1149457,__ND1149641__Project(LEFT));
END;
