...
EXPORT B_Property_Event_8(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE211214 := __E_Property_Event;
  EXPORT __ST169466_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST169466_Layout __ND211282__Project(E_Property_Event(__in,__cfg).Layout __PP210877) := TRANSFORM
    SELF.Dt_First_Seen_ := KEL.era.ToDate(__PP210877.Date_First_Seen_);
    SELF := __PP210877;
  END;
  EXPORT __ENH_Property_Event_8 := PROJECT(__EE211214,__ND211282__Project(LEFT));
END;
