...
EXPORT B_Criminal_Offense_6(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1089356 := __ENH_Criminal_Offense_7;
  EXPORT __ST166914_Layout := RECORD
  ...
  END;
  EXPORT __ST166867_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST166914_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST166867_Layout __ND1089734__Project(B_Criminal_Offense_7(__in,__cfg).__ST167961_Layout __PP1089357) := TRANSFORM
    __EE1089517 := __PP1089357.Offense_Charges_;
    __ST166914_Layout __ND1089721__Project(B_Criminal_Offense_7(__in,__cfg).__ST168008_Layout __PP1089518) := TRANSFORM
      __CC14101 := '-99998';
      SELF.Valid_Date_ := IF(__T(__FN1(KEL.Routines.IsValidDate,__PP1089518.My_Crim_Date_)),__ECAST(KEL.typ.nstr,__FN2(KEL.Routines.DateToString,__PP1089518.My_Crim_Date_,__CN('%Y%m%d'))),__ECAST(KEL.typ.nstr,__CN(__CC14101)));
      SELF := __PP1089518;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE1089517,__ND1089721__Project(LEFT));
    SELF := __PP1089357;
  END;
  EXPORT __ENH_Criminal_Offense_6 := PROJECT(__EE1089356,__ND1089734__Project(LEFT));
END;
