...
EXPORT B_Property_Event_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1088517 := __ENH_Property_Event_8;
  EXPORT __ST168635_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST168635_Layout __ND1088522__Project(B_Property_Event_8(__in,__cfg).__ST169466_Layout __PP1088518) := TRANSFORM
    SELF.Dt_Last_Seen_ := KEL.era.ToDate(__PP1088518.Date_Last_Seen_);
    SELF := __PP1088518;
  END;
  EXPORT __ENH_Property_Event_7 := PROJECT(__EE1088517,__ND1088522__Project(LEFT));
END;
