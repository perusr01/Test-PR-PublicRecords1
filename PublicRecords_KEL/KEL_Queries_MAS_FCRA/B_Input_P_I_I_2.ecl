...
EXPORT B_Input_P_I_I_2(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1264902 := __ENH_Input_P_I_I_3;
  ...
  END;
  SHARED __ST156192_Layout __ND1265504__Project(B_Input_P_I_I_3(__in,__cfg).__ST160063_Layout __PP1264903) := TRANSFORM
    SELF.C_U_R_R_E_N_T___D_A_T_E__1_Y_E_A_R_S_ := KEL.Routines.AdjustCalendar(__cfg.CurrentDate, -1,0,0);
    __CC13664 := '-99999';
    __CC13669 := '-99998';
    SELF.Input_D_O_B_Clean_Value_ := FN_Compile(__cfg).FN_Is_Blank2_Fields(__ECAST(KEL.typ.nstr,__PP1264903.P___Inp_D_O_B_),__ECAST(KEL.typ.nstr,__CN(__CC13664)),__ECAST(KEL.typ.nstr,__ECAST(KEL.typ.nstr,__PP1264903.P___Inp_Cln_D_O_B_)),__ECAST(KEL.typ.nstr,__CN(__CC13669)));
    SELF.Input_Home_Phone_Clean_Value_ := FN_Compile(__cfg).FN_Is_Blank2_Fields(__ECAST(KEL.typ.nstr,__PP1264903.P___Inp_Phone_Home_),__ECAST(KEL.typ.nstr,__CN(__CC13664)),__ECAST(KEL.typ.nstr,__PP1264903.P___Inp_Cln_Phone_Home_),__ECAST(KEL.typ.nstr,__CN(__CC13669)));
    SELF.Input_Primary_Name_Clean_Value_ := MAP(__PP1264903.Addr_Not_Populated_=>__ECAST(KEL.typ.nstr,__CN(__CC13664)),__T(__PP1264903.City_State_Zip_Not_Populated_)=>__ECAST(KEL.typ.nstr,__CN(__CC13669)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP1264903.P___Inp_Cln_Addr_Prim_Name_),__ECAST(KEL.typ.nstr,__CN(__CC13669)))));
    SELF.Input_Zip5_Clean_Value_ := MAP(__T(__AND(__CN(__PP1264903.P___Inp_Addr_Zip_Flag_Value_ = '0'),__OR(__CN(__PP1264903.Addr_Not_Populated_),__PP1264903.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13664)),__T(__AND(__CN(__PP1264903.P___Inp_Addr_Zip_Flag_Value_ = '1'),__OR(__CN(__PP1264903.Addr_Not_Populated_),__PP1264903.City_State_Zip_Not_Populated_)))=>__ECAST(KEL.typ.nstr,__CN(__CC13669)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP1264903.P___Inp_Cln_Addr_Zip5_),__ECAST(KEL.typ.nstr,__CN(__CC13669)))));
    SELF.P___Inp_Cln_Arch_Dt_Flag_Value_ := FN_Compile(__cfg).FN_Is_Echo_Populated(__ECAST(KEL.typ.nstr,__PP1264903.P___Inp_Cln_Arch_Dt_));
    SELF := __PP1264903;
  END;
  EXPORT __ENH_Input_P_I_I_2 := PROJECT(__EE1264902,__ND1265504__Project(LEFT));
END;
