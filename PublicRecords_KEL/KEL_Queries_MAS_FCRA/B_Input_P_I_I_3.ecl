...
EXPORT B_Input_P_I_I_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1151264 := __ENH_Input_P_I_I_4;
  ...
  END;
  SHARED __ST160063_Layout __ND1151856__Project(B_Input_P_I_I_4(__in,__cfg).__ST173446_Layout __PP1151265) := TRANSFORM
    SELF.Addr_Not_Populated_ := FN_Compile(__cfg).FN_Is_Not_Enough_To_Clean(__ECAST(KEL.typ.nstr,__PP1151265.P___Inp_Addr_));
    SELF.City_State_Zip_Not_Populated_ := FN_Compile(__cfg).FN_City_State_Zip_Not_Populated_Check(__ECAST(KEL.typ.nstr,__PP1151265.P___Inp_Addr_City_),__ECAST(KEL.typ.nstr,__PP1151265.P___Inp_Addr_State_),__ECAST(KEL.typ.nstr,__PP1151265.P___Inp_Addr_Zip_));
    __CC13669 := '-99998';
    __CC13664 := '-99999';
    SELF.Input_First_Name_Clean_Value_ := MAP(__PP1151265.P___Inp_Val_Name_Bogus_Flag_ = (KEL.typ.str)1=>__ECAST(KEL.typ.nstr,__CN(__CC13669)),__ECAST(KEL.typ.nstr,IF(__PP1151265.Name_Not_Populated_,__ECAST(KEL.typ.nstr,__CN(__CC13664)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP1151265.P___Inp_Cln_Name_First_),__ECAST(KEL.typ.nstr,__CN(__CC13669)))))));
    SELF.Input_Last_Name_Clean_Value_ := MAP(__PP1151265.P___Inp_Val_Name_Bogus_Flag_ = (KEL.typ.str)1=>__ECAST(KEL.typ.nstr,__CN(__CC13669)),__ECAST(KEL.typ.nstr,IF(__PP1151265.Name_Not_Populated_,__ECAST(KEL.typ.nstr,__CN(__CC13664)),__ECAST(KEL.typ.nstr,FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP1151265.P___Inp_Cln_Name_Last_),__ECAST(KEL.typ.nstr,__CN(__CC13669)))))));
    SELF.P___Inp_Addr_Zip_Flag_Value_ := FN_Compile(__cfg).FN_Is_Echo_Populated(__ECAST(KEL.typ.nstr,__PP1151265.P___Inp_Addr_Zip_));
    SELF := __PP1151265;
  END;
  EXPORT __ENH_Input_P_I_I_3 := PROJECT(__EE1151264,__ND1151856__Project(LEFT));
END;
