...
EXPORT Q_F_C_R_A_Person_Attributes_V1_Dynamic(KEL.typ.uid __PLexID_in, DATASET(RECORDOF(PublicRecords_KEL.ECL_Functions.Layouts.LayoutInputPII)) __PInputPIIDataset, KEL.typ.kdate __PP_InpClnArchDt, DATA57 __PDPM, CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault) := MODULE
  ...
  SHARED __EE2441660 := __ENH_Person;
  SHARED __EE2444697 := __EE2441660(__T(__OP2(__EE2441660.UID,=,__CN(__PLexID_in))));
  SHARED __ST95538_Layout := RECORD
    ...
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST90231_Layout) Crim_List_;
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST90252_Layout) Banko_List_;
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST90275_Layout) Ln_J7_Y_List_;
    KEL.typ.ndataset(B_Person(__in,__cfg_Local).__ST90298_Layout) L_T_D7_Y_List_;
  ...
  END;
  SHARED __ST95538_Layout __ND2444702__Project(B_Person(__in,__cfg_Local).__ST150144_Layout __PP2444698) := TRANSFORM
    SELF.Lex_I_D_ := __PP2444698.UID;
    SELF.P___Lex_I_D_Seen_Flag_ := __PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_;
    __CC14178 := '-99999';
    SELF.P___Lex_I_D_Is_Deceased_Flag_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14178,__PP2444698.P___Lex_I_D_Is_Deceased_Flag_);
    __CC14176 := -99999;
    SELF.P_L___Ast_Veh_Air_Cnt_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Ast_Veh_Air_Cnt_Ev_);
    SELF.P_L___Ast_Veh_Air_Emrg_Dt_List_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Ast_Veh_Air_Emrg_Dt_List_Ev_));
    SELF.P_L___Ast_Veh_Air_Emrg_New_Dt_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Ast_Veh_Air_Emrg_New_Dt_Ev_));
    SELF.P_L___Ast_Veh_Air_Emrg_Old_Dt_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Ast_Veh_Air_Emrg_Old_Dt_Ev_));
    SELF.P_L___Ast_Veh_Air_Emrg_New_Msnc_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14176)),__ECAST(KEL.typ.nint,__PP2444698.P_L___Ast_Veh_Air_Emrg_New_Msnc_Ev_));
    SELF.P_L___Ast_Veh_Air_Emrg_Old_Msnc_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14176)),__ECAST(KEL.typ.nint,__PP2444698.P_L___Ast_Veh_Air_Emrg_Old_Msnc_Ev_));
    SELF.P_L___Ast_Veh_Wtr_Cnt_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Ast_Veh_Wtr_Cnt_Ev_);
    SELF.P_L___Ast_Veh_Wtr_Emrg_Dt_List_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Ast_Veh_Wtr_Emrg_Dt_List_Ev_));
    SELF.P_L___Ast_Veh_Wtr_Emrg_New_Dt_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Ast_Veh_Wtr_Emrg_New_Dt_Ev_));
    SELF.P_L___Ast_Veh_Wtr_Emrg_Old_Dt_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Ast_Veh_Wtr_Emrg_Old_Dt_Ev_));
    SELF.P_L___Ast_Veh_Wtr_Emrg_New_Msnc_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14176)),__ECAST(KEL.typ.nint,__PP2444698.P_L___Ast_Veh_Wtr_Emrg_New_Msnc_Ev_));
    SELF.P_L___Ast_Veh_Wtr_Emrg_Old_Msnc_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14176)),__ECAST(KEL.typ.nint,__PP2444698.P_L___Ast_Veh_Wtr_Emrg_Old_Msnc_Ev_));
    SELF.P_L___Drg_Crim_Fel_Cnt1_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Drg_Crim_Fel_Cnt1_Y_F_C_R_A_);
    SELF.P_L___Drg_Crim_Fel_Cnt7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Drg_Crim_Fel_Cnt7_Y_F_C_R_A_);
    SELF.P_L___Drg_Crim_Fel_New_Dt1_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_Crim_Fel_New_Dt1_Y_F_C_R_A_));
    SELF.P_L___Drg_Crim_Fel_Old_Dt1_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_Crim_Fel_Old_Dt1_Y_F_C_R_A_));
    SELF.P_L___Drg_Crim_Fel_New_Dt7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_Crim_Fel_New_Dt7_Y_F_C_R_A_));
    SELF.P_L___Drg_Crim_Fel_Old_Dt7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_Crim_Fel_Old_Dt7_Y_F_C_R_A_));
    SELF.P_L___Drg_Crim_Fel_New_Msnc1_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14176)),__ECAST(KEL.typ.nint,__PP2444698.P_L___Drg_Crim_Fel_New_Msnc1_Y_F_C_R_A_));
    SELF.P_L___Drg_Crim_Fel_Old_Msnc1_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14176)),__ECAST(KEL.typ.nint,__PP2444698.P_L___Drg_Crim_Fel_Old_Msnc1_Y_F_C_R_A_));
    SELF.P_L___Drg_Crim_Fel_New_Msnc7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14176)),__ECAST(KEL.typ.nint,__PP2444698.P_L___Drg_Crim_Fel_New_Msnc7_Y_F_C_R_A_));
    SELF.P_L___Drg_Crim_Fel_Old_Msnc7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14176)),__ECAST(KEL.typ.nint,__PP2444698.P_L___Drg_Crim_Fel_Old_Msnc7_Y_F_C_R_A_));
    SELF.P_L___Drg_Crim_Nfel_Cnt1_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Drg_Crim_Nfel_Cnt1_Y_F_C_R_A_);
    SELF.P_L___Drg_Crim_Nfel_Cnt7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Drg_Crim_Nfel_Cnt7_Y_F_C_R_A_);
    SELF.P_L___Drg_Crim_Nfel_New_Dt1_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_Crim_Nfel_New_Dt1_Y_F_C_R_A_));
    SELF.P_L___Drg_Crim_Nfel_Old_Dt1_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_Crim_Nfel_Old_Dt1_Y_F_C_R_A_));
    SELF.P_L___Drg_Crim_Nfel_New_Dt7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_Crim_Nfel_New_Dt7_Y_F_C_R_A_));
    SELF.P_L___Drg_Crim_Nfel_Old_Dt7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_Crim_Nfel_Old_Dt7_Y_F_C_R_A_));
    SELF.P_L___Drg_Crim_Nfel_New_Msnc1_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14176)),__ECAST(KEL.typ.nint,__PP2444698.P_L___Drg_Crim_Nfel_New_Msnc1_Y_F_C_R_A_));
    SELF.P_L___Drg_Crim_Nfel_Old_Msnc1_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14176)),__ECAST(KEL.typ.nint,__PP2444698.P_L___Drg_Crim_Nfel_Old_Msnc1_Y_F_C_R_A_));
    SELF.P_L___Drg_Crim_Nfel_New_Msnc7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14176)),__ECAST(KEL.typ.nint,__PP2444698.P_L___Drg_Crim_Nfel_New_Msnc7_Y_F_C_R_A_));
    SELF.P_L___Drg_Crim_Nfel_Old_Msnc7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14176)),__ECAST(KEL.typ.nint,__PP2444698.P_L___Drg_Crim_Nfel_Old_Msnc7_Y_F_C_R_A_));
    SELF.P_L___Drg_Crim_Cnt1_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Drg_Crim_Cnt1_Y_F_C_R_A_);
    SELF.P_L___Drg_Crim_Cnt7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Drg_Crim_Cnt7_Y_F_C_R_A_);
    SELF.P_L___Drg_Crim_New_Dt1_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_Crim_New_Dt1_Y_F_C_R_A_));
    SELF.P_L___Drg_Crim_Old_Dt1_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_Crim_Old_Dt1_Y_F_C_R_A_));
    SELF.P_L___Drg_Crim_New_Dt7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_Crim_New_Dt7_Y_F_C_R_A_));
    SELF.P_L___Drg_Crim_Old_Dt7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_Crim_Old_Dt7_Y_F_C_R_A_));
    SELF.P_L___Drg_Crim_New_Msnc1_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14176)),__ECAST(KEL.typ.nint,__PP2444698.P_L___Drg_Crim_New_Msnc1_Y_F_C_R_A_));
    SELF.P_L___Drg_Crim_Old_Msnc1_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14176)),__ECAST(KEL.typ.nint,__PP2444698.P_L___Drg_Crim_Old_Msnc1_Y_F_C_R_A_));
    SELF.P_L___Drg_Crim_New_Msnc7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14176)),__ECAST(KEL.typ.nint,__PP2444698.P_L___Drg_Crim_New_Msnc7_Y_F_C_R_A_));
    SELF.P_L___Drg_Crim_Old_Msnc7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14176)),__ECAST(KEL.typ.nint,__PP2444698.P_L___Drg_Crim_Old_Msnc7_Y_F_C_R_A_));
    SELF.P_L___Drg_Crim_Severity_Indx7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_Crim_Severity_Indx7_Y_F_C_R_A_));
    SELF.P_L___Drg_Crim_Behavior_Indx7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_Crim_Behavior_Indx7_Y_F_C_R_A_));
    SELF.P_L___Drg_Bk_Cnt1_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Drg_Bk_Cnt1_Y_);
    SELF.P_L___Drg_Bk_Cnt7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Drg_Bk_Cnt7_Y_);
    SELF.P_L___Drg_Bk_Cnt10_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Drg_Bk_Cnt10_Y_);
    SELF.P_L___Drg_Bk_Dt_List1_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_Bk_Dt_List1_Y_));
    SELF.P_L___Drg_Bk_Dt_List7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_Bk_Dt_List7_Y_));
    SELF.P_L___Drg_Bk_Dt_List10_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_Bk_Dt_List10_Y_));
    SELF.P_L___Drg_Bk_New_Dt1_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_Bk_New_Dt1_Y_));
    SELF.P_L___Drg_Bk_New_Dt7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_Bk_New_Dt7_Y_));
    SELF.P_L___Drg_Bk_New_Dt10_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_Bk_New_Dt10_Y_));
    SELF.P_L___Drg_Bk_Old_Dt1_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_Bk_Old_Dt1_Y_));
    SELF.P_L___Drg_Bk_Old_Dt7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_Bk_Old_Dt7_Y_));
    SELF.P_L___Drg_Bk_Old_Dt10_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_Bk_Old_Dt10_Y_));
    SELF.P_L___Drg_Bk_New_Msnc1_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14176)),__ECAST(KEL.typ.nint,__PP2444698.P_L___Drg_Bk_New_Msnc1_Y_));
    SELF.P_L___Drg_Bk_New_Msnc7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14176)),__ECAST(KEL.typ.nint,__PP2444698.P_L___Drg_Bk_New_Msnc7_Y_));
    SELF.P_L___Drg_Bk_New_Msnc10_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14176)),__ECAST(KEL.typ.nint,__PP2444698.P_L___Drg_Bk_New_Msnc10_Y_));
    SELF.P_L___Drg_Bk_Old_Msnc1_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14176)),__ECAST(KEL.typ.nint,__PP2444698.P_L___Drg_Bk_Old_Msnc1_Y_));
    SELF.P_L___Drg_Bk_Old_Msnc7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14176)),__ECAST(KEL.typ.nint,__PP2444698.P_L___Drg_Bk_Old_Msnc7_Y_));
    SELF.P_L___Drg_Bk_Old_Msnc10_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14176)),__ECAST(KEL.typ.nint,__PP2444698.P_L___Drg_Bk_Old_Msnc10_Y_));
    SELF.P_L___Drg_Bk_Ch_List1_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_Bk_Ch_List1_Y_));
    SELF.P_L___Drg_Bk_Ch_List7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_Bk_Ch_List7_Y_));
    SELF.P_L___Drg_Bk_Ch_List10_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_Bk_Ch_List10_Y_));
    SELF.P_L___Drg_Bk_New_Ch_Type1_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_Bk_New_Ch_Type1_Y_));
    SELF.P_L___Drg_Bk_New_Ch_Type7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_Bk_New_Ch_Type7_Y_));
    SELF.P_L___Drg_Bk_New_Ch_Type10_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_Bk_New_Ch_Type10_Y_));
    SELF.P_L___Drg_Bk_Ch7_Cnt1_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Drg_Bk_Ch7_Cnt1_Y_);
    SELF.P_L___Drg_Bk_Ch7_Cnt7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Drg_Bk_Ch7_Cnt7_Y_);
    SELF.P_L___Drg_Bk_Ch7_Cnt10_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Drg_Bk_Ch7_Cnt10_Y_);
    SELF.P_L___Drg_Bk_Ch13_Cnt1_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Drg_Bk_Ch13_Cnt1_Y_);
    SELF.P_L___Drg_Bk_Ch13_Cnt7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Drg_Bk_Ch13_Cnt7_Y_);
    SELF.P_L___Drg_Bk_Ch13_Cnt10_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Drg_Bk_Ch13_Cnt10_Y_);
    SELF.P_L___Drg_Bk_Updt_New_Dt1_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_Bk_Updt_New_Dt1_Y_));
    SELF.P_L___Drg_Bk_Updt_New_Dt7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_Bk_Updt_New_Dt7_Y_));
    SELF.P_L___Drg_Bk_Updt_New_Dt10_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_Bk_Updt_New_Dt10_Y_));
    SELF.P_L___Drg_Bk_Updt_New_Msnc1_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(__CC14176))),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_Bk_Updt_New_Msnc1_Y_));
    SELF.P_L___Drg_Bk_Updt_New_Msnc7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(__CC14176))),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_Bk_Updt_New_Msnc7_Y_));
    SELF.P_L___Drg_Bk_Updt_New_Msnc10_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(__CC14176))),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_Bk_Updt_New_Msnc10_Y_));
    SELF.P_L___Drg_Bk_Disp_List1_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_Bk_Disp_List1_Y_));
    SELF.P_L___Drg_Bk_Disp_List7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_Bk_Disp_List7_Y_));
    SELF.P_L___Drg_Bk_Disp_List10_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN('')),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_Bk_Disp_List10_Y_));
    SELF.P_L___Drg_Bk_New_Disp_Type1_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_Bk_New_Disp_Type1_Y_));
    SELF.P_L___Drg_Bk_New_Disp_Type7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_Bk_New_Disp_Type7_Y_));
    SELF.P_L___Drg_Bk_New_Disp_Type10_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_Bk_New_Disp_Type10_Y_));
    SELF.P_L___Drg_Bk_New_Disp_Dt1_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_Bk_New_Disp_Dt1_Y_));
    SELF.P_L___Drg_Bk_New_Disp_Dt7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_Bk_New_Disp_Dt7_Y_));
    SELF.P_L___Drg_Bk_New_Disp_Dt10_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_Bk_New_Disp_Dt10_Y_));
    SELF.P_L___Drg_Bk_New_Disp_Msnc1_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(__CC14176))),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_Bk_New_Disp_Msnc1_Y_));
    SELF.P_L___Drg_Bk_New_Disp_Msnc7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(__CC14176))),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_Bk_New_Disp_Msnc7_Y_));
    SELF.P_L___Drg_Bk_New_Disp_Msnc10_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(__CC14176))),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_Bk_New_Disp_Msnc10_Y_));
    SELF.P_L___Drg_Bk_Disp_Cnt1_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Drg_Bk_Disp_Cnt1_Y_);
    SELF.P_L___Drg_Bk_Disp_Cnt7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Drg_Bk_Disp_Cnt7_Y_);
    SELF.P_L___Drg_Bk_Disp_Cnt10_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Drg_Bk_Disp_Cnt10_Y_);
    SELF.P_L___Drg_Bk_Dsms_Cnt1_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Drg_Bk_Dsms_Cnt1_Y_);
    SELF.P_L___Drg_Bk_Dsms_Cnt7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Drg_Bk_Dsms_Cnt7_Y_);
    SELF.P_L___Drg_Bk_Dsms_Cnt10_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Drg_Bk_Dsms_Cnt10_Y_);
    SELF.P_L___Drg_Bk_Dsch_Cnt1_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Drg_Bk_Dsch_Cnt1_Y_);
    SELF.P_L___Drg_Bk_Dsch_Cnt7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Drg_Bk_Dsch_Cnt7_Y_);
    SELF.P_L___Drg_Bk_Dsch_Cnt10_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Drg_Bk_Dsch_Cnt10_Y_);
    SELF.P_L___Drg_Bk_Type_List1_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_Bk_Type_List1_Y_));
    SELF.P_L___Drg_Bk_Type_List7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_Bk_Type_List7_Y_));
    SELF.P_L___Drg_Bk_Type_List10_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_Bk_Type_List10_Y_));
    SELF.P_L___Drg_Bk_Bus_Flag1_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_Bk_Bus_Flag1_Y_));
    SELF.P_L___Drg_Bk_Bus_Flag7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_Bk_Bus_Flag7_Y_));
    SELF.P_L___Drg_Bk_Bus_Flag10_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_Bk_Bus_Flag10_Y_));
    SELF.P_L___Drg_Bk_Severity_Indx10_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14178,__PP2444698.P_L___Drg_Bk_Severity_Indx10_Y_);
    SELF.P_L___Prof_Lic_Flag_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14178,__PP2444698.P_L___Prof_Lic_Flag_Ev_);
    SELF.P_L___Prof_Lic_Cnt_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Prof_Lic_Cnt_Ev_);
    SELF.P_L___Prof_Lic_Issue_Dt_List_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Prof_Lic_Issue_Dt_List_Ev_));
    SELF.P_L___Prof_Lic_Exp_Dt_List_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Prof_Lic_Exp_Dt_List_Ev_));
    SELF.P_L___Prof_Lic_Indx_By_Lic_List_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Prof_Lic_Indx_By_Lic_List_Ev_));
    SELF.P_L___Prof_Lic_Actv_Flag_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14178,__PP2444698.P_L___Prof_Lic_Actv_Flag_);
    SELF.P_L___Prof_Lic_Actv_New_Issue_Dt_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Prof_Lic_Actv_New_Issue_Dt_));
    SELF.P_L___Prof_Lic_Actv_New_Exp_Dt_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Prof_Lic_Actv_New_Exp_Dt_));
    SELF.P_L___Prof_Lic_Actv_New_Type_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Prof_Lic_Actv_New_Type_));
    SELF.P_L___Prof_Lic_Actv_New_Title_Type_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Prof_Lic_Actv_New_Title_Type_));
    SELF.P_L___Prof_Lic_Actv_New_Indx_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Prof_Lic_Actv_New_Indx_));
    SELF.P_L___Prof_Lic_Actv_New_Src_Type_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Prof_Lic_Actv_New_Src_Type_));
    SELF.P_L___Curr_Addr_Full_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14178,__PP2444698.P_L___Curr_Addr_Full_);
    SELF.P_L___Curr_Addr_Loc_I_D_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Curr_Addr_Loc_I_D_));
    SELF.P_L___Prev_Addr_Full_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14178,__PP2444698.P_L___Prev_Addr_Full_);
    SELF.P_L___Prev_Addr_Loc_I_D_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Prev_Addr_Loc_I_D_));
    SELF.P_L___Curr_Addr_Cnty_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14178,__PP2444698.P_L___Curr_Addr_Cnty_);
    SELF.P_L___Curr_Addr_Geo_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14178,__PP2444698.P_L___Curr_Addr_Geo_);
    SELF.P_L___Curr_Addr_Lat_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14178,__PP2444698.P_L___Curr_Addr_Lat_);
    SELF.P_L___Curr_Addr_Lng_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14178,__PP2444698.P_L___Curr_Addr_Lng_);
    SELF.P_L___Curr_Addr_Type_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14178,__PP2444698.P_L___Curr_Addr_Type_);
    SELF.P_L___Curr_Addr_Status_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14178,__PP2444698.P_L___Curr_Addr_Status_);
    SELF.P_L___Prev_Addr_Cnty_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14178,__PP2444698.P_L___Prev_Addr_Cnty_);
    SELF.P_L___Prev_Addr_Geo_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14178,__PP2444698.P_L___Prev_Addr_Geo_);
    SELF.P_L___Prev_Addr_Lat_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14178,__PP2444698.P_L___Prev_Addr_Lat_);
    SELF.P_L___Prev_Addr_Lng_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14178,__PP2444698.P_L___Prev_Addr_Lng_);
    SELF.P_L___Prev_Addr_Type_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14178,__PP2444698.P_L___Prev_Addr_Type_);
    SELF.P_L___Prev_Addr_Status_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14178,__PP2444698.P_L___Prev_Addr_Status_);
    SELF.P_L___Curr_Addr_Is_Vacant_Flag_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Curr_Addr_Is_Vacant_Flag_);
    SELF.P_L___Curr_Addr_Is_Throwback_Flag_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Curr_Addr_Is_Throwback_Flag_);
    SELF.P_L___Curr_Addr_Seasonal_Type_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Curr_Addr_Seasonal_Type_);
    SELF.P_L___Curr_Addr_Is_D_N_D_Flag_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Curr_Addr_Is_D_N_D_Flag_);
    SELF.P_L___Curr_Addr_Is_College_Flag_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Curr_Addr_Is_College_Flag_);
    SELF.P_L___Curr_Addr_Is_C_M_R_A_Flag_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Curr_Addr_Is_C_M_R_A_Flag_);
    SELF.P_L___Curr_Addr_Is_Simp_Addr_Flag_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Curr_Addr_Is_Simp_Addr_Flag_);
    SELF.P_L___Curr_Addr_Is_Drop_Delivery_Flag_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Curr_Addr_Is_Drop_Delivery_Flag_);
    SELF.P_L___Curr_Addr_Is_Business_Flag_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Curr_Addr_Is_Business_Flag_);
    SELF.P_L___Curr_Addr_Is_Multi_Unit_Flag_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Curr_Addr_Is_Multi_Unit_Flag_);
    SELF.P_L___Curr_Addr_Is_Apt_Flag_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Curr_Addr_Is_Apt_Flag_);
    SELF.P_L___Addr_Hist_On_File_Flag_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14178,__PP2444698.P_L___Addr_Hist_On_File_Flag_);
    SELF.P_L___Addr_Emrg_Cnt3_M_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Addr_Emrg_Cnt3_M_);
    SELF.P_L___Addr_Emrg_Cnt6_M_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Addr_Emrg_Cnt6_M_);
    SELF.P_L___Addr_Emrg_Cnt1_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Addr_Emrg_Cnt1_Y_);
    SELF.P_L___Addr_Emrg_Cnt2_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Addr_Emrg_Cnt2_Y_);
    SELF.P_L___Addr_Emrg_Cnt3_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Addr_Emrg_Cnt3_Y_);
    SELF.P_L___Addr_Emrg_Cnt5_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Addr_Emrg_Cnt5_Y_);
    SELF.P_L___Addr_Emrg_Cnt7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Addr_Emrg_Cnt7_Y_);
    SELF.P_L___Addr_Emrg_Cnt10_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Addr_Emrg_Cnt10_Y_);
    SELF.P_L___Addr_Emrg_Cnt15_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Addr_Emrg_Cnt15_Y_);
    SELF.P_L___Best_Name_First_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Best_Name_First_));
    SELF.P_L___Best_Name_Mid_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Best_Name_Mid_));
    SELF.P_L___Best_Name_Last_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Best_Name_Last_));
    SELF.P_L___Best_S_S_N_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Best_S_S_N_));
    SELF.P_L___Best_D_O_B_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Best_D_O_B_));
    SELF.P_L___Best_D_O_B_Age_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14176)),__ECAST(KEL.typ.nint,__PP2444698.P_L___Best_D_O_B_Age_));
    SELF.P_L___Prev_Addr_Is_Simp_Addr_Flag_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Prev_Addr_Is_Simp_Addr_Flag_);
    SELF.P_L___Prev_Addr_Is_Business_Flag_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Prev_Addr_Is_Business_Flag_);
    SELF.P_L___Drg_Judg_Cnt7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Drg_Judg_Cnt7_Y_);
    SELF.P_L___Drg_L_T_D_Cnt7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Drg_L_T_D_Cnt7_Y_);
    SELF.P_L___Drg_L_T_D_Cnt1_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Drg_L_T_D_Cnt1_Y_);
    SELF.P_L___Drg_L_T_D_Amt_Tot7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Drg_L_T_D_Amt_Tot7_Y_);
    SELF.P_L___Drg_L_T_D_New_Dt7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_L_T_D_New_Dt7_Y_));
    SELF.P_L___Drg_L_T_D_Old_Dt7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_L_T_D_Old_Dt7_Y_));
    SELF.P_L___Drg_L_T_D_Amt_List7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_L_T_D_Amt_List7_Y_));
    SELF.P_L___Drg_L_T_D_Dt_List7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_L_T_D_Dt_List7_Y_));
    SELF.P_L___Drg_L_T_D_New_Msnc7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14176)),__ECAST(KEL.typ.nint,__PP2444698.P_L___Drg_L_T_D_New_Msnc7_Y_));
    SELF.P_L___Drg_L_T_D_Old_Msnc7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14176)),__ECAST(KEL.typ.nint,__PP2444698.P_L___Drg_L_T_D_Old_Msnc7_Y_));
    SELF.P_L___Drg_Lien_Cnt7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Drg_Lien_Cnt7_Y_);
    ...
    SELF.P_L___Drg_Ln_J_Cnt7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Drg_Ln_J_Cnt7_Y_);
    SELF.P_L___Drg_Ln_J_Amt_List7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_Ln_J_Amt_List7_Y_));
    SELF.P_L___Drg_Ln_J_Dt_List7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_Ln_J_Dt_List7_Y_));
    SELF.P_L___Drg_Ln_J_New_Dt7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_Ln_J_New_Dt7_Y_));
    SELF.P_L___Drg_Ln_J_New_Msnc7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14176)),__ECAST(KEL.typ.nint,__PP2444698.P_L___Drg_Ln_J_New_Msnc7_Y_));
    SELF.P_L___Drg_Ln_J_Old_Dt7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Drg_Ln_J_Old_Dt7_Y_));
    SELF.P_L___Drg_Ln_J_Old_Msnc7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14176)),__ECAST(KEL.typ.nint,__PP2444698.P_L___Drg_Ln_J_Old_Msnc7_Y_));
    SELF.P_L___Drg_Cnt7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Drg_Cnt7_Y_F_C_R_A_);
    SELF.P_L___Drg_Old_Msnc7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14176)),__ECAST(KEL.typ.nint,__PP2444698.P_L___Drg_Old_Msnc7_Y_F_C_R_A_));
    SELF.P_L___Drg_New_Msnc7_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14176)),__ECAST(KEL.typ.nint,__PP2444698.P_L___Drg_New_Msnc7_Y_F_C_R_A_));
    SELF.Crim_List_ := __PP2444698.Crim_List_F_C_R_A_;
    SELF.P_L___Edu_Rec_Flag_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14178,__PP2444698.P_L___Edu_Rec_Flag_Ev_);
    SELF.P_L___Edu_Src_List_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Edu_Src_List_Ev_));
    SELF.P_L___Edu_H_S_Rec_Flag_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14178,__PP2444698.P_L___Edu_H_S_Rec_Flag_Ev_);
    SELF.P_L___Edu_Coll_Rec_Flag_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14178,__PP2444698.P_L___Edu_Coll_Rec_Flag_Ev_);
    SELF.P_L___Edu_Coll_Src_Emrg_Dt_List_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Edu_Coll_Src_Emrg_Dt_List_Ev_));
    SELF.P_L___Edu_Coll_Src_Last_Dt_List_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Edu_Coll_Src_Last_Dt_List_Ev_));
    SELF.P_L___Edu_Coll_Src_New_Rec_Old_Dt_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Edu_Coll_Src_New_Rec_Old_Dt_Ev_));
    SELF.P_L___Edu_Coll_Src_New_Rec_New_Dt_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Edu_Coll_Src_New_Rec_New_Dt_Ev_));
    SELF.P_L___Edu_Coll_Src_New_Rec_Old_Msnc_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(__CC14176))),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Edu_Coll_Src_New_Rec_Old_Msnc_Ev_));
    SELF.P_L___Edu_Coll_Src_New_Rec_New_Msnc_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(__CC14176))),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Edu_Coll_Src_New_Rec_New_Msnc_Ev_));
    SELF.P_L___Edu_Coll_Rec_Span_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(__CC14176))),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Edu_Coll_Rec_Span_Ev_));
    SELF.P_L___Email_Cnt_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Email_Cnt_Ev_F_C_R_A_);
    SELF.P_L___Email_Flag_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Email_Flag_Ev_F_C_R_A_));
    SELF.P_L___Email_Free_Cnt_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Email_Free_Cnt_Ev_F_C_R_A_);
    SELF.P_L___Email_I_S_P_Cnt_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Email_I_S_P_Cnt_Ev_F_C_R_A_);
    SELF.P_L___Email_Edu_Cnt_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Email_Edu_Cnt_Ev_F_C_R_A_);
    SELF.P_L___Email_Corp_Cnt_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Email_Corp_Cnt_Ev_F_C_R_A_);
    SELF.P_L___Ast_Prop_Cnt_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Ast_Prop_Cnt_Ev_);
    SELF.P_L___Ast_Prop_New_Dt_List_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Ast_Prop_New_Dt_List_Ev_));
    SELF.P_L___Ast_Prop_Old_Dt_List_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Ast_Prop_Old_Dt_List_Ev_));
    SELF.P_L___Ast_Prop_Curr_Cnt_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Ast_Prop_Curr_Cnt_);
    SELF.P_L___Ast_Prop_Flag_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14176)),__ECAST(KEL.typ.nint,__PP2444698.P_L___Ast_Prop_Flag_Ev_));
    SELF.P_L___Ast_Prop_Curr_Flag_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14176)),__ECAST(KEL.typ.nint,__PP2444698.P_L___Ast_Prop_Curr_Flag_));
    SELF.P_L___Ast_Prop_Ownership_Indx_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14176)),__ECAST(KEL.typ.nint,__PP2444698.P_L___Ast_Prop_Ownership_Indx_));
    SELF.P_L___Ast_Prop_Curr_W_Mkt_Val_Cnt_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Ast_Prop_Curr_W_Mkt_Val_Cnt_);
    SELF.P_L___Ast_Prop_Curr_Mkt_Val_List_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Ast_Prop_Curr_Mkt_Val_List_));
    SELF.P_L___Ast_Prop_Curr_W_Tax_Val_Cnt_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Ast_Prop_Curr_W_Tax_Val_Cnt_);
    SELF.P_L___Ast_Prop_Curr_Tax_Val_List_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Ast_Prop_Curr_Tax_Val_List_));
    SELF.P_L___Ast_Prop_Curr_Tax_Val_Tot_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Ast_Prop_Curr_Tax_Val_Tot_);
    SELF.P_L___Ast_Prop_Curr_W_A_V_M_Val_Cnt_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Ast_Prop_Curr_W_A_V_M_Val_Cnt_);
    SELF.P_L___Ast_Prop_Curr_A_V_M_Val_List_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Ast_Prop_Curr_A_V_M_Val_List_));
    SELF.P_L___Ast_Prop_Curr_A_V_M_Val_Tot_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14176)),__ECAST(KEL.typ.nint,__PP2444698.P_L___Ast_Prop_Curr_A_V_M_Val_Tot_));
    SELF.P_L___Ast_Prop_Curr_A_V_M_Val_Avg_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nfloat,__CAST(KEL.typ.float,__CN(__CC14176))),__ECAST(KEL.typ.nfloat,__PP2444698.P_L___Ast_Prop_Curr_A_V_M_Val_Avg_));
    SELF.P_L___Ast_Prop_Purch_Cnt_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Ast_Prop_Purch_Cnt_Ev_);
    SELF.P_L___Ast_Prop_Purch_Dt_List_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(__CC14176))),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Ast_Prop_Purch_Dt_List_Ev_));
    SELF.P_L___Ast_Prop_Purch_New_Dt_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(__CC14176))),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Ast_Prop_Purch_New_Dt_Ev_));
    SELF.P_L___Ast_Prop_Purch_Old_Dt_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(__CC14176))),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Ast_Prop_Purch_Old_Dt_Ev_));
    SELF.P_L___Ast_Prop_Purch_New_Msnc_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(__CC14176))),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Ast_Prop_Purch_New_Msnc_Ev_));
    SELF.P_L___Ast_Prop_Purch_Old_Msnc_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CAST(KEL.typ.str,__CN(__CC14176))),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Ast_Prop_Purch_Old_Msnc_Ev_));
    SELF.P_L___Ast_Prop_Purch_Cnt1_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Ast_Prop_Purch_Cnt1_Y_);
    SELF.P_L___Ast_Prop_Purch_Cnt5_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Ast_Prop_Purch_Cnt5_Y_);
    SELF.P_L___Ast_Prop_Sale_Cnt_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Ast_Prop_Sale_Cnt_Ev_);
    SELF.P_L___Ast_Prop_Sale_Amt_List_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Ast_Prop_Sale_Amt_List_Ev_));
    SELF.P_L___Ast_Prop_Sale_Tot_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Ast_Prop_Sale_Tot_Ev_);
    SELF.P_L___Ast_Prop_Sale_Dt_List_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Ast_Prop_Sale_Dt_List_Ev_));
    SELF.P_L___Ast_Prop_Sale_New_Dt_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Ast_Prop_Sale_New_Dt_Ev_));
    SELF.P_L___Ast_Prop_Sale_Old_Dt_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Ast_Prop_Sale_Old_Dt_Ev_));
    SELF.P_L___Ast_Prop_Sale_New_Msnc_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14176)),__ECAST(KEL.typ.nint,__PP2444698.P_L___Ast_Prop_Sale_New_Msnc_Ev_));
    SELF.P_L___Ast_Prop_Sale_Old_Msnc_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14176)),__ECAST(KEL.typ.nint,__PP2444698.P_L___Ast_Prop_Sale_Old_Msnc_Ev_));
    SELF.P_L___Inq_Per_Lex_I_D_Cnt1_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Inq_Per_Lex_I_D_Cnt1_Y_);
    SELF.P_L___Inq_S_S_N_Per_Lex_I_D_Cnt1_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14176)),__ECAST(KEL.typ.nint,__PP2444698.P_L___Inq_S_S_N_Per_Lex_I_D_Cnt1_Y_));
    SELF.P_L___Inq_Addr_Per_Lex_I_D_Cnt1_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14176)),__ECAST(KEL.typ.nint,__PP2444698.P_L___Inq_Addr_Per_Lex_I_D_Cnt1_Y_));
    SELF.P_L___Inq_L_Name_Per_Lex_I_D_Cnt1_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14176)),__ECAST(KEL.typ.nint,__PP2444698.P_L___Inq_L_Name_Per_Lex_I_D_Cnt1_Y_));
    SELF.P_L___Inq_F_Name_Per_Lex_I_D_Cnt1_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14176)),__ECAST(KEL.typ.nint,__PP2444698.P_L___Inq_F_Name_Per_Lex_I_D_Cnt1_Y_));
    SELF.P_L___Inq_Phone_Per_Lex_I_D_Cnt1_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14176)),__ECAST(KEL.typ.nint,__PP2444698.P_L___Inq_Phone_Per_Lex_I_D_Cnt1_Y_));
    SELF.P_L___Inq_D_O_B_Per_Lex_I_D_Cnt1_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14176)),__ECAST(KEL.typ.nint,__PP2444698.P_L___Inq_D_O_B_Per_Lex_I_D_Cnt1_Y_));
    SELF.P_L___Inq_Per_Lex_I_D_W_Inp_F_L_S_Cnt1_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14176)),__ECAST(KEL.typ.nint,__PP2444698.P_L___Inq_Per_Lex_I_D_W_Inp_F_L_S_Cnt1_Y_));
    SELF.P_L___Inq_Per_Lex_I_D_W_Inp_A_S_Cnt1_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14176)),__ECAST(KEL.typ.nint,__PP2444698.P_L___Inq_Per_Lex_I_D_W_Inp_A_S_Cnt1_Y_));
    SELF.P_L___Inq_Per_Lex_I_D_W_Inp_S_D_Cnt1_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14176)),__ECAST(KEL.typ.nint,__PP2444698.P_L___Inq_Per_Lex_I_D_W_Inp_S_D_Cnt1_Y_));
    SELF.P_L___Inq_Per_Lex_I_D_W_Inp_P_S_Cnt1_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14176)),__ECAST(KEL.typ.nint,__PP2444698.P_L___Inq_Per_Lex_I_D_W_Inp_P_S_Cnt1_Y_));
    SELF.P_L___Inq_Per_Lex_I_D_W_Inp_F_L_A_S_Cnt1_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14176)),__ECAST(KEL.typ.nint,__PP2444698.P_L___Inq_Per_Lex_I_D_W_Inp_F_L_A_S_Cnt1_Y_));
    SELF.P_L___Inq_Per_Lex_I_D_W_Inp_F_L_P_S_Cnt1_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14176)),__ECAST(KEL.typ.nint,__PP2444698.P_L___Inq_Per_Lex_I_D_W_Inp_F_L_P_S_Cnt1_Y_));
    SELF.P_L___Inq_Per_Lex_I_D_W_Inp_F_L_A_P_S_Cnt1_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14176)),__ECAST(KEL.typ.nint,__PP2444698.P_L___Inq_Per_Lex_I_D_W_Inp_F_L_A_P_S_Cnt1_Y_));
    SELF.P_L___S_T_L_Cnt1_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14176)),__ECAST(KEL.typ.nint,__PP2444698.P_L___S_T_L_Cnt1_Y_));
    SELF.P_L___S_T_L_Cnt2_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14176)),__ECAST(KEL.typ.nint,__PP2444698.P_L___S_T_L_Cnt2_Y_));
    SELF.P_L___S_T_L_Cnt5_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14176)),__ECAST(KEL.typ.nint,__PP2444698.P_L___S_T_L_Cnt5_Y_));
    SELF.P_L___S_T_L_Dt_List5_Y_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___S_T_L_Dt_List5_Y_));
    SELF.P_L___Ver_Src_Cnt_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14176,__PP2444698.P_L___Ver_Src_Cnt_Ev_F_C_R_A_);
    SELF.P_L___Ver_Src_List_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Ver_Src_List_Ev_F_C_R_A_));
    SELF.P_L___Ver_Src_Emrg_Dt_List_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Ver_Src_Emrg_Dt_List_Ev_F_C_R_A_));
    SELF.P_L___Ver_Src_Last_Dt_List_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Ver_Src_Last_Dt_List_Ev_F_C_R_A_));
    SELF.P_L___Ver_Src_Old_Dt_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Ver_Src_Old_Dt_Ev_F_C_R_A_));
    SELF.P_L___Ver_Src_New_Dt_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Ver_Src_New_Dt_Ev_F_C_R_A_));
    SELF.P___Lex_I_D_Rstd_Only_Flag_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14178,__PP2444698.P___Lex_I_D_Rstd_Only_Flag_F_C_R_A_);
    SELF.P_L___Ver_Name_First_Src_Cnt_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14176)),__ECAST(KEL.typ.nint,__PP2444698.P_L___Ver_Name_First_Src_Cnt_Ev_F_C_R_A_));
    SELF.P_L___Ver_Name_First_Src_List_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Ver_Name_First_Src_List_Ev_F_C_R_A_));
    SELF.P_L___Ver_Name_First_Src_Emrg_Dt_List_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Ver_Name_First_Src_Emrg_Dt_List_Ev_F_C_R_A_));
    SELF.P_L___Ver_Name_First_Src_Last_Dt_List_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Ver_Name_First_Src_Last_Dt_List_Ev_F_C_R_A_));
    SELF.P_L___Ver_Name_Last_Src_Cnt_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14176)),__ECAST(KEL.typ.nint,__PP2444698.P_L___Ver_Name_Last_Src_Cnt_Ev_F_C_R_A_));
    SELF.P_L___Ver_Name_Last_Src_List_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Ver_Name_Last_Src_List_Ev_F_C_R_A_));
    SELF.P_L___Ver_Name_Last_Src_Emrg_Dt_List_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Ver_Name_Last_Src_Emrg_Dt_List_Ev_F_C_R_A_));
    SELF.P_L___Ver_Name_Last_Src_Last_Dt_List_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Ver_Name_Last_Src_Last_Dt_List_Ev_F_C_R_A_));
    SELF.P_L___Ver_S_S_N_Src_Cnt_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14176)),__ECAST(KEL.typ.nint,__PP2444698.P_L___Ver_S_S_N_Src_Cnt_Ev_F_C_R_A_));
    SELF.P_L___Ver_S_S_N_Src_List_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Ver_S_S_N_Src_List_Ev_F_C_R_A_));
    SELF.P_L___Ver_S_S_N_Src_Emrg_Dt_List_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Ver_S_S_N_Src_Emrg_Dt_List_Ev_F_C_R_A_));
    SELF.P_L___Ver_S_S_N_Src_Last_Dt_List_Ev_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nstr,__CN(__CC14178)),__ECAST(KEL.typ.nstr,__PP2444698.P_L___Ver_S_S_N_Src_Last_Dt_List_Ev_F_C_R_A_));
    SELF.P_L___Alrt_Corrected_Flag_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14178,__PP2444698.P_L___Alrt_Corrected_Flag_);
    SELF.P_L___Alrt_Cons_Statement_Flag_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14178,__PP2444698.P_L___Alrt_Cons_Statement_Flag_);
    SELF.P_L___Alrt_Dispute_Flag_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14178,__PP2444698.P_L___Alrt_Dispute_Flag_);
    SELF.P_L___Alrt_Security_Freeze_Flag_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14178,__PP2444698.P_L___Alrt_Security_Freeze_Flag_);
    SELF.P_L___Alrt_Security_Alert_Flag_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14178,__PP2444698.P_L___Alrt_Security_Alert_Flag_);
    SELF.P_L___Alrt_I_D_Theft_Flag_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__CC14178,__PP2444698.P_L___Alrt_I_D_Theft_Flag_);
    SELF.P_L___Emrg_Age_ := IF(__PP2444698.P___Lex_I_D_Seen_Flag_F_C_R_A_ = '0',__ECAST(KEL.typ.nint,__CN(__CC14176)),__ECAST(KEL.typ.nint,__PP2444698.P_L___Emrg_Age_));
    SELF := __PP2444698;
  END;
  EXPORT Res0 := __UNWRAP(PROJECT(__EE2444697,__ND2444702__Project(LEFT)));
