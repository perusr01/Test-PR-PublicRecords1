...
EXPORT B_Criminal_Offense_7(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE213125 := __E_Criminal_Offense;
  ...
  EXPORT __ST167961_Layout := RECORD
    ...
    KEL.typ.ndataset(__ST168008_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST167961_Layout __ND213757__Project(E_Criminal_Offense(__in,__cfg).Layout __PP212720) := TRANSFORM
    __EE212945 := __PP212720.Offense_Charges_;
    __ST168008_Layout __ND213380__Project(E_Criminal_Offense(__in,__cfg).Offense_Charges_Layout __PP213376) := TRANSFORM
      SELF.My_Crim_Date_ := KEL.era.ToDate(__PP213376.Date_First_Seen_);
      SELF := __PP213376;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE212945,__ND213380__Project(LEFT));
    SELF := __PP212720;
  END;
  EXPORT __ENH_Criminal_Offense_7 := PROJECT(__EE213125,__ND213757__Project(LEFT));
END;
