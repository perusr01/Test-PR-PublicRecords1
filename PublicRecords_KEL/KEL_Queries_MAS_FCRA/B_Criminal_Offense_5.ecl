...
EXPORT B_Criminal_Offense_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1109254 := __ENH_Criminal_Offense_6;
  EXPORT __ST165055_Layout := RECORD
  ...
  END;
  EXPORT __ST165008_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST165055_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST165008_Layout __ND1109174__Project(B_Criminal_Offense_6(__in,__cfg).__ST166867_Layout __PP1108622) := TRANSFORM
    __EE1109257 := __PP1108622.Offense_Charges_;
    __ST165055_Layout __ND1109132__Project(B_Criminal_Offense_6(__in,__cfg).__ST166914_Layout __PP1108783) := TRANSFORM
      __EE1109127 := __PP1108622.Offense_Charges_;
      SELF.Criminal_Date_ := KEL.Aggregates.MinNN(__EE1109127,KEL.Routines.CastStringToDate(__T(__EE1109127).Valid_Date_));
      SELF.Dismissed_Charges_ := __OR(IF(__T(__NT(__PP1108622.Court_Disposition_Description_)),__ECAST(KEL.typ.nbool,__CN(FALSE)),__ECAST(KEL.typ.nbool,__OP2(__PP1108622.Court_Disposition_Description_,=,__CN('DISMISSED')))),IF(__T(__NT(__PP1108622.Court_Additional_Disposition_Description_)),__ECAST(KEL.typ.nbool,__CN(FALSE)),__ECAST(KEL.typ.nbool,__OP2(__PP1108622.Court_Additional_Disposition_Description_,=,__CN('DISMISSED')))));
      SELF := __PP1108783;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE1109257,__ND1109132__Project(LEFT));
    SELF := __PP1108622;
  END;
  EXPORT __ENH_Criminal_Offense_5 := PROJECT(__EE1109254,__ND1109174__Project(LEFT));
END;
