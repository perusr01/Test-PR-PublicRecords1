...
EXPORT B_Input_P_I_I_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1516740 := __ENH_Input_P_I_I_2;
  EXPORT __ST151138_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST151138_Layout __ND1516745__Project(B_Input_P_I_I_2(__in,__cfg).__ST156192_Layout __PP1516741) := TRANSFORM
    ...
    __CC13664 := '-99999';
    __CC13669 := '-99998';
    SELF.P___Inp_Cln_Arch_Dt_F1_Y_ := MAP(__PP1516741.P___Inp_Cln_Arch_Dt_Flag_Value_ <> '1'=>__CC13664,__PP1516741.C_U_R_R_E_N_T___D_A_T_E__1_Y_E_A_R_S_ > KEL.Routines.Today()=>__CC13669,KEL.Routines.DateToString(__PP1516741.C_U_R_R_E_N_T___D_A_T_E__1_Y_E_A_R_S_,'%Y%m%d'));
    SELF := __PP1516741;
  END;
  EXPORT __ENH_Input_P_I_I_1 := PROJECT(__EE1516740,__ND1516745__Project(LEFT));
END;
