...
EXPORT B_Input_P_I_I_5(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1109343 := __ENH_Input_P_I_I_6;
  EXPORT __ST173110_Layout := RECORD
    KEL.typ.nuid UID;
  ...
  END;
  SHARED __ST173110_Layout __ND1109895__Project(B_Input_P_I_I_8(__in,__cfg).__ST168942_Layout __PP1109344) := TRANSFORM
    __CC13664 := '-99999';
    SELF.Input_First_Name_Value_ := FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP1109344.P___Inp_Name_First_),__ECAST(KEL.typ.nstr,__CN(__CC13664)));
    SELF.Input_Last_Name_Value_ := FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP1109344.P___Inp_Name_Last_),__ECAST(KEL.typ.nstr,__CN(__CC13664)));
    SELF.Input_Middle_Name_Value_ := FN_Compile(__cfg).FN_Is_Blank(__ECAST(KEL.typ.nstr,__PP1109344.P___Inp_Name_Mid_),__ECAST(KEL.typ.nstr,__CN(__CC13664)));
    SELF := __PP1109344;
  END;
  EXPORT __ENH_Input_P_I_I_5 := PROJECT(__EE1109343,__ND1109895__Project(LEFT));
END;
