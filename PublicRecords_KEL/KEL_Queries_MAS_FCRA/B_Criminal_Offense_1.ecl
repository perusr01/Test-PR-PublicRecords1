...
EXPORT B_Criminal_Offense_1(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1516281 := __ENH_Criminal_Offense_2;
  EXPORT __ST150883_Layout := RECORD
  ...
  END;
  EXPORT __ST150836_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST150883_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST150836_Layout __ND1516286__Project(B_Criminal_Offense_2(__in,__cfg).__ST155775_Layout __PP1516282) := TRANSFORM
    __EE1516442 := __PP1516282.Offense_Charges_;
    SELF.Offense_Charges_ := __PROJECT(__EE1516442,__ST150883_Layout);
    SELF := __PP1516282;
  END;
  EXPORT __ENH_Criminal_Offense_1 := PROJECT(__EE1516281,__ND1516286__Project(LEFT));
END;
