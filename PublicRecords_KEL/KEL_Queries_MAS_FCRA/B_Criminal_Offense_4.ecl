...
EXPORT B_Criminal_Offense_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1130600 := __ENH_Criminal_Offense_5;
  EXPORT __ST162785_Layout := RECORD
  ...
  END;
  EXPORT __ST162738_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST162785_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST162738_Layout __ND1131015__Project(B_Criminal_Offense_5(__in,__cfg).__ST165008_Layout __PP1130601) := TRANSFORM
    __EE1130761 := __PP1130601.Offense_Charges_;
    __ST162785_Layout __ND1130998__Project(B_Criminal_Offense_5(__in,__cfg).__ST165055_Layout __PP1130762) := TRANSFORM
      ...
      SELF.Age_In_Days_ := FN_Compile(__cfg).FN_A_B_S_D_A_Y_S_B_E_T_W_E_E_N(__ECAST(KEL.typ.nkdate,__PP1130762.Criminal_Date_),__ECAST(KEL.typ.nkdate,__CC13319));
      SELF.Is_Criminal_Count_F_C_R_A_ := __AND(__AND(__AND(__NOT(__PP1130762.Dismissed_Charges_),__OP2(__PP1130762.Offense_Score_,IN,__CN(['M','F']))),__OP2(__PP1130762.Conviction_Flag_,IN,__CN(['Y','D']))),__OP2(__PP1130762.Traffic_Flag_,=,__CN('N')));
      SELF := __PP1130762;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE1130761,__ND1130998__Project(LEFT));
    SELF := __PP1130601;
  END;
  EXPORT __ENH_Criminal_Offense_4 := PROJECT(__EE1130600,__ND1131015__Project(LEFT));
END;
