...
EXPORT B_Criminal_Offense_3(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1150577 := __ENH_Criminal_Offense_4;
  EXPORT __ST159744_Layout := RECORD
  ...
  END;
  EXPORT __ST159697_Layout := RECORD
    KEL.typ.nuid UID;
    ...
    KEL.typ.ndataset(__ST159744_Layout) Offense_Charges_;
    ...
    KEL.typ.int __RecordCount := 0;
  END;
  SHARED __ST159697_Layout __ND1151009__Project(B_Criminal_Offense_4(__in,__cfg).__ST162738_Layout __PP1150578) := TRANSFORM
    __EE1150738 := __PP1150578.Offense_Charges_;
    __ST159744_Layout __ND1150991__Project(B_Criminal_Offense_4(__in,__cfg).__ST162785_Layout __PP1150739) := TRANSFORM
      SELF.Is_Felony_F_C_R_A_ := __AND(__AND(__AND(__AND(__NOT(__PP1150739.Dismissed_Charges_),IF(__T(__NT(__PP1150739.Offense_Score_)),__ECAST(KEL.typ.nbool,__CN(FALSE)),__ECAST(KEL.typ.nbool,__OP2(__PP1150739.Offense_Score_,=,__CN('F'))))),__NT(__PP1150739.Offender_Level_)),__OP2(__PP1150739.Conviction_Flag_,IN,__CN(['Y','D']))),__OP2(__PP1150739.Traffic_Flag_,=,__CN('N')));
      SELF := __PP1150739;
    END;
    SELF.Offense_Charges_ := __PROJECT(__EE1150738,__ND1150991__Project(LEFT));
    SELF := __PP1150578;
  END;
  EXPORT __ENH_Criminal_Offense_3 := PROJECT(__EE1150577,__ND1151009__Project(LEFT));
END;
