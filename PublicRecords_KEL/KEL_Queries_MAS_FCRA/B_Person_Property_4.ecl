...
EXPORT B_Person_Property_4(CFG_Compile.FDCDataset __in = CFG_Compile.FDCDefault, CFG_Compile __cfg = CFG_Compile) := MODULE
  ...
  SHARED __EE1149119 := __ENH_Person_Property_5;
  EXPORT __ST176107_Layout := RECORD
  ...
  END;
  SHARED __ST176107_Layout __ND1149124__Project(B_Person_Property_5(__in,__cfg).__ST172347_Layout __PP1149120) := TRANSFORM
    SELF.Is_Currently_Owned_ := (__PP1149120.Property_Is_Owned_Assessment_ OR __PP1149120.Property_Is_Owned_Deed_) AND NOT (__PP1149120.Property_Is_Sold_);
    ...
    SELF.Property_Purchase_Date_Last_Seen_ := KEL.Routines.MinN(__PP1149120.Property_Purchase_Date_Last_Seen_Capped_,__CC13407);
    SELF := __PP1149120;
  END;
  EXPORT __ENH_Person_Property_4 := PROJECT(__EE1149119,__ND1149124__Project(LEFT));
END;
